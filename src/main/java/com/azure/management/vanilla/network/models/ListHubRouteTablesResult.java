...
public final class ListHubRouteTablesResult {
    ...
    private List<HubRouteTable> value;
     ...
     */
    public List<HubRouteTable> getValue() {
        return this.value;
    }
     ...
     */
    public ListHubRouteTablesResult setValue(List<HubRouteTable> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListHubRouteTablesResult object itself.
     */
    public ListHubRouteTablesResult setNextLink(String nextLink) {
