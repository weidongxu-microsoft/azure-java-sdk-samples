...
public final class HubRoute {
     ...
     */
    public HubRoute setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the HubRoute object itself.
     */
    public HubRoute setDestinationType(String destinationType) {
     ...
     * @return the HubRoute object itself.
     */
    public HubRoute setDestinations(List<String> destinations) {
     ...
     * @return the HubRoute object itself.
     */
    public HubRoute setNextHopType(String nextHopType) {
     ...
     * @return the HubRoute object itself.
     */
    public HubRoute setNextHop(String nextHop) {
