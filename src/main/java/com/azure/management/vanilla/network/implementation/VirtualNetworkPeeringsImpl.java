...
import com.azure.management.vanilla.network.models.VirtualNetworkPeeringListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in VirtualNetworkPeerings. */
public final class VirtualNetworkPeeringsImpl {
    private final ClientLogger logger = new ClientLogger(VirtualNetworkPeeringsImpl.class);
    ...
    /**
     * Initializes an instance of VirtualNetworkPeeringsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VirtualNetworkPeeringsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    private interface VirtualNetworkPeeringsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetworkPeering>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
            @PathParam("virtualNetworkPeeringName") String virtualNetworkPeeringName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") VirtualNetworkPeering virtualNetworkPeeringParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetworkPeering>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
            @PathParam("virtualNetworkPeeringName") String virtualNetworkPeeringName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualNetworkPeering>> getWithResponseAsync(
        String resourceGroupName, String virtualNetworkName, String virtualNetworkPeeringName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
    ...
    public PollerFlux<PollResult<VirtualNetworkPeering>, VirtualNetworkPeering> beginCreateOrUpdate(
        ...
        return this
            .client
            .<VirtualNetworkPeering, VirtualNetworkPeering>getLroResultAsync(
                mono, this.client.getHttpPipeline(), VirtualNetworkPeering.class, VirtualNetworkPeering.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetworkPeering> createOrUpdateAsync(
        String resourceGroupName,
        String virtualNetworkName,
        String virtualNetworkPeeringName,
        VirtualNetworkPeering virtualNetworkPeeringParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkPeering>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<VirtualNetworkPeering>>map(
                res ->
    ...
    public PagedFlux<VirtualNetworkPeering> listAsync(String resourceGroupName, String virtualNetworkName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetworkPeering> listAsync(
        String resourceGroupName, String virtualNetworkName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualNetworkPeering>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String virtualNetworkName,
        String virtualNetworkPeeringName,
        VirtualNetworkPeering virtualNetworkPeeringParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetworkPeering> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String virtualNetworkName,
        String virtualNetworkPeeringName,
        VirtualNetworkPeering virtualNetworkPeeringParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkPeering>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkPeering>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
