...
public final class StaticRoute {
     ...
     */
    public StaticRoute setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the StaticRoute object itself.
     */
    public StaticRoute setAddressPrefixes(List<String> addressPrefixes) {
     ...
     * @return the StaticRoute object itself.
     */
    public StaticRoute setNextHopIpAddress(String nextHopIpAddress) {
