...
public final class VpnServerConfigVpnClientRootCertificate {
     ...
     */
    public VpnServerConfigVpnClientRootCertificate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VpnServerConfigVpnClientRootCertificate object itself.
     */
    public VpnServerConfigVpnClientRootCertificate setPublicCertData(String publicCertData) {
