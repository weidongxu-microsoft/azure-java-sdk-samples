...
public final class ConnectionMonitorTcpConfiguration {
     ...
     */
    public ConnectionMonitorTcpConfiguration setPort(Integer port) {
        this.port = port;
        return this;
    }
     ...
     */
    public Boolean isDisableTraceRoute() {
     ...
     * @return the ConnectionMonitorTcpConfiguration object itself.
     */
    public ConnectionMonitorTcpConfiguration setDisableTraceRoute(Boolean disableTraceRoute) {
