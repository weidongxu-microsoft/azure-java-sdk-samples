...
@Fluent
public final class BastionShareableLink {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BastionShareableLink.class);
     ...
     * @return the BastionShareableLink object itself.
     */
    public BastionShareableLink setVm(Resource vm) {
        this.vm = vm;
        return this;
    }
    ...
    public void validate() {
        if (getVm() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property vm in model BastionShareableLink"));
        }
    }
}
