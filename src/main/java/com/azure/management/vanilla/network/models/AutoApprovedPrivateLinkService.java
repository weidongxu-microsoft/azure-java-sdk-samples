...
@Fluent
public final class AutoApprovedPrivateLinkService {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AutoApprovedPrivateLinkService.class);
     ...
     * @return the AutoApprovedPrivateLinkService object itself.
     */
    public AutoApprovedPrivateLinkService setPrivateLinkService(String privateLinkService) {
