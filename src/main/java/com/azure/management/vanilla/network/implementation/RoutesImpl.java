...
import com.azure.management.vanilla.network.models.RouteListResult;
...
public final class RoutesImpl {
     ...
     */
    RoutesImpl(NetworkManagementClientImpl client) {
    ...
    private interface RoutesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") Route routeParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Route>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("routeTableName") String routeTableName,
            @PathParam("routeName") String routeName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Route>> getWithResponseAsync(
        String resourceGroupName, String routeTableName, String routeName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Route> getAsync(String resourceGroupName, String routeTableName, String routeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Route> getAsync(String resourceGroupName, String routeTableName, String routeName, Context context) {
    ...
    public PollerFlux<PollResult<Route>, Route> beginCreateOrUpdate(
        ...
        return this
            .client
            .<Route, Route>getLroResultAsync(mono, this.client.getHttpPipeline(), Route.class, Route.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Route> createOrUpdateAsync(
        String resourceGroupName, String routeTableName, String routeName, Route routeParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, routeTableName, routeName, routeParameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Route>> listSinglePageAsync(String resourceGroupName, String routeTableName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Route>> listSinglePageAsync(
    ...
    public PagedFlux<Route> listAsync(String resourceGroupName, String routeTableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Route> listAsync(String resourceGroupName, String routeTableName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Route>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String routeTableName, String routeName, Route routeParameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Route> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String routeTableName, String routeName, Route routeParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Route>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Route>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
