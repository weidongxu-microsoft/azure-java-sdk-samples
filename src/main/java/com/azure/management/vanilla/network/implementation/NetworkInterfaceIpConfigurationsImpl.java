...
public final class NetworkInterfaceIpConfigurationsImpl {
    private final ClientLogger logger = new ClientLogger(NetworkInterfaceIpConfigurationsImpl.class);
    ...
    /**
     * Initializes an instance of NetworkInterfaceIpConfigurationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    NetworkInterfaceIpConfigurationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface NetworkInterfaceIpConfigurationsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceIpConfiguration>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
    ...
    public Mono<PagedResponse<NetworkInterfaceIpConfiguration>> listSinglePageAsync(
    ...
    public PagedFlux<NetworkInterfaceIpConfiguration> listAsync(String resourceGroupName, String networkInterfaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<NetworkInterfaceIpConfiguration> listAsync(
        String resourceGroupName, String networkInterfaceName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<NetworkInterfaceIpConfiguration>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<NetworkInterfaceIpConfiguration> getAsync(
        String resourceGroupName, String networkInterfaceName, String ipConfigurationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<NetworkInterfaceIpConfiguration>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<NetworkInterfaceIpConfiguration>> listNextSinglePageAsync(
