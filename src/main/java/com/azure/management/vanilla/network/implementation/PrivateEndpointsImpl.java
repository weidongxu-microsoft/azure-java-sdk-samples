...
import com.azure.management.vanilla.network.models.PrivateEndpointListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in PrivateEndpoints. */
public final class PrivateEndpointsImpl
    implements InnerSupportsGet<PrivateEndpoint>, InnerSupportsListing<PrivateEndpoint>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(PrivateEndpointsImpl.class);
    ...
    /**
     * Initializes an instance of PrivateEndpointsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    PrivateEndpointsImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface PrivateEndpointsService {
        ...
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<PrivateEndpoint>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateEndpointName") String privateEndpointName,
            @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") PrivateEndpoint parameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ErrorException.class)
        Mono<Response<PrivateEndpoint>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("privateEndpointName") String privateEndpointName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<PrivateEndpoint>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateEndpoint> getByResourceGroupAsync(String resourceGroupName, String privateEndpointName) {
    ...
    public PollerFlux<PollResult<PrivateEndpoint>, PrivateEndpoint> beginCreateOrUpdate(
        ...
        return this
            .client
            .<PrivateEndpoint, PrivateEndpoint>getLroResultAsync(
                mono, this.client.getHttpPipeline(), PrivateEndpoint.class, PrivateEndpoint.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateEndpoint> createOrUpdateAsync(
        String resourceGroupName, String privateEndpointName, PrivateEndpoint parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, privateEndpointName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<PrivateEndpoint>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listByResourceGroupSinglePageAsync(
    ...
    public PagedFlux<PrivateEndpoint> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<PrivateEndpoint> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<PrivateEndpoint> listAsync() {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<PrivateEndpoint> listAsync(Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<PrivateEndpoint>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String privateEndpointName, PrivateEndpoint parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateEndpoint> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String privateEndpointName, PrivateEndpoint parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listBySubscriptionNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<PrivateEndpoint>> listBySubscriptionNextSinglePageAsync(
