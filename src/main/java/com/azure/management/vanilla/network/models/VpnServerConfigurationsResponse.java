...
@Fluent
public final class VpnServerConfigurationsResponse {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VpnServerConfigurationsResponse.class);
     ...
     */
    public List<String> getVpnServerConfigurationResourceIds() {
     ...
     * @return the VpnServerConfigurationsResponse object itself.
     */
    public VpnServerConfigurationsResponse setVpnServerConfigurationResourceIds(
