...
public final class AvailableDelegationsImpl {
    private final ClientLogger logger = new ClientLogger(AvailableDelegationsImpl.class);
    ...
    /**
     * Initializes an instance of AvailableDelegationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    AvailableDelegationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    public Mono<PagedResponse<AvailableDelegation>> listSinglePageAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<AvailableDelegation>> listSinglePageAsync(String location, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<AvailableDelegation> listAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<AvailableDelegation> listAsync(String location, Context context) {
