...
public class ConnectionMonitor {
     ...
     */
    public ConnectionMonitor setLocation(String location) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setTags(Map<String, String> tags) {
        this.tags = tags;
        return this;
    }
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setSource(ConnectionMonitorSource source) {
        this.source = source;
        return this;
    }
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setDestination(ConnectionMonitorDestination destination) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setAutoStart(Boolean autoStart) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setMonitoringIntervalInSeconds(Integer monitoringIntervalInSeconds) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setEndpoints(List<ConnectionMonitorEndpoint> endpoints) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setTestConfigurations(List<ConnectionMonitorTestConfiguration> testConfigurations) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setTestGroups(List<ConnectionMonitorTestGroup> testGroups) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setOutputs(List<ConnectionMonitorOutput> outputs) {
     ...
     * @return the ConnectionMonitor object itself.
     */
    public ConnectionMonitor setNotes(String notes) {
        this.notes = notes;
        return this;
    }
