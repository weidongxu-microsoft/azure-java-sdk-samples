...
import com.azure.management.vanilla.network.models.ExpressRouteLinkListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in ExpressRouteLinks. */
public final class ExpressRouteLinksImpl {
    private final ClientLogger logger = new ClientLogger(ExpressRouteLinksImpl.class);
    ...
    /**
     * Initializes an instance of ExpressRouteLinksImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRouteLinksImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface ExpressRouteLinksService {
        ...
        Mono<Response<ExpressRouteLink>> get(
    ...
    public Mono<Response<ExpressRouteLink>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteLink> getAsync(String resourceGroupName, String expressRoutePortName, String linkName) {
        return getWithResponseAsync(resourceGroupName, expressRoutePortName, linkName)
            .flatMap(
                (Response<ExpressRouteLink> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteLink> getAsync(
        String resourceGroupName, String expressRoutePortName, String linkName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteLink>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            expressRoutePortName,
                            context))
            .<PagedResponse<ExpressRouteLink>>map(
                res ->
    ...
    public PagedFlux<ExpressRouteLink> listAsync(String resourceGroupName, String expressRoutePortName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ExpressRouteLink> listAsync(
        String resourceGroupName, String expressRoutePortName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteLink>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteLink>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
