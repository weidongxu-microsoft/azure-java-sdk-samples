...
/** The ListVirtualHubRouteTableV2SResult model. */
@Fluent
public final class ListVirtualHubRouteTableV2SResult {
    ...
    private List<VirtualHubRouteTableV2> value;
     ...
     */
    public List<VirtualHubRouteTableV2> getValue() {
        return this.value;
    }
     ...
     */
    public ListVirtualHubRouteTableV2SResult setValue(List<VirtualHubRouteTableV2> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVirtualHubRouteTableV2SResult object itself.
     */
    public ListVirtualHubRouteTableV2SResult setNextLink(String nextLink) {
