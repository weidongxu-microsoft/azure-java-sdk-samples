...
import com.azure.management.vanilla.network.models.AuthorizationListResult;
...
public final class ExpressRouteCircuitAuthorizationsImpl {
    private final ClientLogger logger = new ClientLogger(ExpressRouteCircuitAuthorizationsImpl.class);
    ...
    /**
     * Initializes an instance of ExpressRouteCircuitAuthorizationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRouteCircuitAuthorizationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface ExpressRouteCircuitAuthorizationsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteCircuitAuthorization>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("circuitName") String circuitName,
            @PathParam("authorizationName") String authorizationName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ExpressRouteCircuitAuthorization authorizationParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteCircuitAuthorization>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("circuitName") String circuitName,
            @PathParam("authorizationName") String authorizationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRouteCircuitAuthorization>> getWithResponseAsync(
        String resourceGroupName, String circuitName, String authorizationName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitAuthorization> getAsync(
        String resourceGroupName, String circuitName, String authorizationName) {
        return getWithResponseAsync(resourceGroupName, circuitName, authorizationName)
            .flatMap(
                (Response<ExpressRouteCircuitAuthorization> res) -> {
    ...
    public PollerFlux<PollResult<ExpressRouteCircuitAuthorization>, ExpressRouteCircuitAuthorization>
        ...
        return this
            .client
            .<ExpressRouteCircuitAuthorization, ExpressRouteCircuitAuthorization>getLroResultAsync(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitAuthorization> createOrUpdateAsync(
        String resourceGroupName,
        String circuitName,
        String authorizationName,
        ExpressRouteCircuitAuthorization authorizationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitAuthorization>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<ExpressRouteCircuitAuthorization>>map(
                res ->
    ...
    public PagedFlux<ExpressRouteCircuitAuthorization> listAsync(String resourceGroupName, String circuitName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ExpressRouteCircuitAuthorization> listAsync(
        String resourceGroupName, String circuitName, Context context) {
        return new PagedFlux<>(
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String circuitName, String authorizationName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, circuitName, authorizationName)
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String circuitName, String authorizationName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, circuitName, authorizationName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String circuitName, String authorizationName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, circuitName, authorizationName).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String circuitName, String authorizationName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, circuitName, authorizationName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRouteCircuitAuthorization>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String circuitName,
        String authorizationName,
        ExpressRouteCircuitAuthorization authorizationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitAuthorization> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String circuitName,
        String authorizationName,
        ExpressRouteCircuitAuthorization authorizationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitAuthorization>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitAuthorization>> listNextSinglePageAsync(
