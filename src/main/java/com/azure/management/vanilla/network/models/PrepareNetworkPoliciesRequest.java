...
public final class PrepareNetworkPoliciesRequest {
     ...
     * @return the PrepareNetworkPoliciesRequest object itself.
     */
    public PrepareNetworkPoliciesRequest setNetworkIntentPolicyConfigurations(
    ...
    public void validate() {
        if (getNetworkIntentPolicyConfigurations() != null) {
            getNetworkIntentPolicyConfigurations().forEach(e -> e.validate());
        }
    }
}
