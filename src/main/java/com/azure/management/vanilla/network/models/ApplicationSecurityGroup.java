...
@JsonFlatten
@Fluent
public class ApplicationSecurityGroup extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ApplicationSecurityGroup.class);
     ...
     */
    public ApplicationSecurityGroup setId(String id) {
        this.id = id;
        return this;
    }
