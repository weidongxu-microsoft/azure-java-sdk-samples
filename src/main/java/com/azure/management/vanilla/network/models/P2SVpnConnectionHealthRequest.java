...
public final class P2SVpnConnectionHealthRequest {
     ...
     */
    public P2SVpnConnectionHealthRequest setVpnUserNamesFilter(List<String> vpnUserNamesFilter) {
     ...
     * @return the P2SVpnConnectionHealthRequest object itself.
     */
    public P2SVpnConnectionHealthRequest setOutputBlobSasUrl(String outputBlobSasUrl) {
