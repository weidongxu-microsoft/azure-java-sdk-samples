...
@Fluent
public final class NextHopResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(NextHopResult.class);
     ...
     * @return the NextHopResult object itself.
     */
    public NextHopResult setNextHopType(NextHopType nextHopType) {
     ...
     * @return the NextHopResult object itself.
     */
    public NextHopResult setNextHopIpAddress(String nextHopIpAddress) {
     ...
     * @return the NextHopResult object itself.
     */
    public NextHopResult setRouteTableId(String routeTableId) {
