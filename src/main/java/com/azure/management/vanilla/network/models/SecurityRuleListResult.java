...
public final class SecurityRuleListResult {
    ...
    private List<SecurityRule> value;
     ...
     */
    public SecurityRuleListResult setValue(List<SecurityRule> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the SecurityRuleListResult object itself.
     */
    public SecurityRuleListResult setNextLink(String nextLink) {
