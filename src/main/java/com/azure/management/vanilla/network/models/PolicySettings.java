...
public final class PolicySettings {
     ...
     */
    public WebApplicationFirewallEnabledState getState() {
        return this.state;
    }
     ...
     */
    public PolicySettings setState(WebApplicationFirewallEnabledState state) {
        this.state = state;
        return this;
    }
     ...
     * @return the PolicySettings object itself.
     */
    public PolicySettings setRequestBodyCheck(Boolean requestBodyCheck) {
     ...
     * @return the PolicySettings object itself.
     */
    public PolicySettings setMaxRequestBodySizeInKb(Integer maxRequestBodySizeInKb) {
     ...
     * @return the PolicySettings object itself.
     */
    public PolicySettings setFileUploadLimitInMb(Integer fileUploadLimitInMb) {
