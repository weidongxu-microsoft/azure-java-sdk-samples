...
public final class BgpSettings {
     ...
     */
    public List<IpConfigurationBgpPeeringAddress> getBgpPeeringAddresses() {
     ...
     * @return the BgpSettings object itself.
     */
    public BgpSettings setBgpPeeringAddresses(List<IpConfigurationBgpPeeringAddress> bgpPeeringAddresses) {
    ...
    public void validate() {
        if (getBgpPeeringAddresses() != null) {
            getBgpPeeringAddresses().forEach(e -> e.validate());
        }
    }
}
