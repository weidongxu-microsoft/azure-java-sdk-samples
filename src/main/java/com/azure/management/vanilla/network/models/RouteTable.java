...
public class RouteTable extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RouteTable.class);
     ...
     */
    public RouteTable setRoutes(List<Route> routes) {
        this.routes = routes;
        return this;
    }
     ...
     * @return the RouteTable object itself.
     */
    public RouteTable setDisableBgpRoutePropagation(Boolean disableBgpRoutePropagation) {
