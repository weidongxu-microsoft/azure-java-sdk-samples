...
public final class ServiceTagsImpl {
    private final ClientLogger logger = new ClientLogger(ServiceTagsImpl.class);
    ...
    /**
     * Initializes an instance of ServiceTagsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ServiceTagsImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface ServiceTagsService {
        ...
        Mono<Response<ServiceTagsListResult>> list(
    ...
    public Mono<Response<ServiceTagsListResult>> listWithResponseAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ServiceTagsListResult>> listWithResponseAsync(String location, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ServiceTagsListResult> listAsync(String location) {
        return listWithResponseAsync(location)
            .flatMap(
                (Response<ServiceTagsListResult> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ServiceTagsListResult> listAsync(String location, Context context) {
