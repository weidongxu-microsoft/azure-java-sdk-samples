...
public final class AvailablePrivateEndpointTypesResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AvailablePrivateEndpointTypesResult.class);

    /*
     * An array of available privateEndpoint type.
     */
    @JsonProperty(value = "value")
    private List<AvailablePrivateEndpointType> value;
     ...
     */
    public List<AvailablePrivateEndpointType> getValue() {
        return this.value;
    }
     ...
     */
    public AvailablePrivateEndpointTypesResult setValue(List<AvailablePrivateEndpointType> value) {
        this.value = value;
        return this;
    }
