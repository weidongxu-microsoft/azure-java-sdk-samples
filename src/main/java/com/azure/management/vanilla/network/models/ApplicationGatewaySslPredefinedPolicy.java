...
@JsonFlatten
@Fluent
public class ApplicationGatewaySslPredefinedPolicy extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ApplicationGatewaySslPredefinedPolicy.class);
     ...
     * @return the ApplicationGatewaySslPredefinedPolicy object itself.
     */
    public ApplicationGatewaySslPredefinedPolicy setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewaySslPredefinedPolicy object itself.
     */
    public ApplicationGatewaySslPredefinedPolicy setCipherSuites(List<ApplicationGatewaySslCipherSuite> cipherSuites) {
     ...
     * @return the ApplicationGatewaySslPredefinedPolicy object itself.
     */
    public ApplicationGatewaySslPredefinedPolicy setMinProtocolVersion(
