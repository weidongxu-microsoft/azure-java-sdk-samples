...
@Fluent
public final class VpnProfileResponse {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VpnProfileResponse.class);
     ...
     * @return the VpnProfileResponse object itself.
     */
    public VpnProfileResponse setProfileUrl(String profileUrl) {
