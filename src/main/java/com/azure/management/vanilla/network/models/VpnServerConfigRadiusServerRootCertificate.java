...
public final class VpnServerConfigRadiusServerRootCertificate {
     ...
     */
    public VpnServerConfigRadiusServerRootCertificate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VpnServerConfigRadiusServerRootCertificate object itself.
     */
    public VpnServerConfigRadiusServerRootCertificate setPublicCertData(String publicCertData) {
