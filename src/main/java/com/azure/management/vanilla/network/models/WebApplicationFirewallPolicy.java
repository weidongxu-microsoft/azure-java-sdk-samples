...
@JsonFlatten
@Fluent
public class WebApplicationFirewallPolicy extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(WebApplicationFirewallPolicy.class);
     ...
     */
    public WebApplicationFirewallPolicy setPolicySettings(PolicySettings policySettings) {
     ...
     */
    public List<WebApplicationFirewallCustomRule> getCustomRules() {
     ...
     * @return the WebApplicationFirewallPolicy object itself.
     */
    public WebApplicationFirewallPolicy setCustomRules(List<WebApplicationFirewallCustomRule> customRules) {
     ...
     */
    public List<ApplicationGateway> getApplicationGateways() {
     ...
     */
    public WebApplicationFirewallPolicyResourceState getResourceState() {
     ...
     * @return the WebApplicationFirewallPolicy object itself.
     */
    public WebApplicationFirewallPolicy setManagedRules(ManagedRulesDefinition managedRules) {
     ...
     */
    public List<SubResource> getHttpListeners() {
     ...
     */
    public List<SubResource> getPathBasedRules() {
     ...
     * @return the WebApplicationFirewallPolicy object itself.
     */
    public WebApplicationFirewallPolicy setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
        if (getPolicySettings() != null) {
            getPolicySettings().validate();
        }
        if (getCustomRules() != null) {
            getCustomRules().forEach(e -> e.validate());
        }
        if (getApplicationGateways() != null) {
            getApplicationGateways().forEach(e -> e.validate());
        }
        if (getManagedRules() != null) {
            getManagedRules().validate();
        }
    }
}
