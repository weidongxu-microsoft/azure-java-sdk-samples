...
public class LocalNetworkGateway extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LocalNetworkGateway.class);
     ...
     * @return the LocalNetworkGateway object itself.
     */
    public LocalNetworkGateway setLocalNetworkAddressSpace(AddressSpace localNetworkAddressSpace) {
     ...
     * @return the LocalNetworkGateway object itself.
     */
    public LocalNetworkGateway setGatewayIpAddress(String gatewayIpAddress) {
     ...
     * @return the LocalNetworkGateway object itself.
     */
    public LocalNetworkGateway setFqdn(String fqdn) {
        this.fqdn = fqdn;
        return this;
    }
     ...
     * @return the LocalNetworkGateway object itself.
     */
    public LocalNetworkGateway setBgpSettings(BgpSettings bgpSettings) {
     ...
     * @return the LocalNetworkGateway object itself.
     */
    public LocalNetworkGateway setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
        if (getLocalNetworkAddressSpace() != null) {
            getLocalNetworkAddressSpace().validate();
        }
