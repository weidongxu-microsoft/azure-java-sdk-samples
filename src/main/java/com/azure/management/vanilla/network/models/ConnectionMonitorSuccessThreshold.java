...
public final class ConnectionMonitorSuccessThreshold {
     ...
     */
    public ConnectionMonitorSuccessThreshold setChecksFailedPercent(Integer checksFailedPercent) {
     ...
     */
    public Float getRoundTripTimeMs() {
     ...
     * @return the ConnectionMonitorSuccessThreshold object itself.
     */
    public ConnectionMonitorSuccessThreshold setRoundTripTimeMs(Float roundTripTimeMs) {
