...
public class PacketCapture {
     ...
     */
    public PacketCapture setTarget(String target) {
        this.target = target;
        return this;
    }
     ...
     * @return the PacketCapture object itself.
     */
    public PacketCapture setBytesToCapturePerPacket(Integer bytesToCapturePerPacket) {
     ...
     * @return the PacketCapture object itself.
     */
    public PacketCapture setTotalBytesPerSession(Integer totalBytesPerSession) {
     ...
     * @return the PacketCapture object itself.
     */
    public PacketCapture setTimeLimitInSeconds(Integer timeLimitInSeconds) {
     ...
     * @return the PacketCapture object itself.
     */
    public PacketCapture setStorageLocation(PacketCaptureStorageLocation storageLocation) {
     ...
     * @return the PacketCapture object itself.
     */
    public PacketCapture setFilters(List<PacketCaptureFilter> filters) {
    ...
    public void validate() {
        if (getTarget() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property target in model PacketCapture"));
        }
        if (getStorageLocation() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property storageLocation in model PacketCapture"));
        } else {
