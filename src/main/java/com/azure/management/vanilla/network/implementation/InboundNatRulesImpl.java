...
import com.azure.management.vanilla.network.models.InboundNatRuleListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in InboundNatRules. */
public final class InboundNatRulesImpl {
    private final ClientLogger logger = new ClientLogger(InboundNatRulesImpl.class);
    ...
    /**
     * Initializes an instance of InboundNatRulesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    InboundNatRulesImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface InboundNatRulesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InboundNatRule>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
            @PathParam("inboundNatRuleName") String inboundNatRuleName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") InboundNatRule inboundNatRuleParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<InboundNatRule>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
            @PathParam("inboundNatRuleName") String inboundNatRuleName,
    ...
    public Mono<PagedResponse<InboundNatRule>> listSinglePageAsync(String resourceGroupName, String loadBalancerName) {
                ...
                context ->
                    service
                        .list(
                            ...
                            context))
            .<PagedResponse<InboundNatRule>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<InboundNatRule>> listSinglePageAsync(
    ...
    public PagedFlux<InboundNatRule> listAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<InboundNatRule> listAsync(String resourceGroupName, String loadBalancerName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<InboundNatRule>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<InboundNatRule> getAsync(String resourceGroupName, String loadBalancerName, String inboundNatRuleName) {
    ...
    public PollerFlux<PollResult<InboundNatRule>, InboundNatRule> beginCreateOrUpdate(
        ...
        return this
            .client
            .<InboundNatRule, InboundNatRule>getLroResultAsync(
                mono, this.client.getHttpPipeline(), InboundNatRule.class, InboundNatRule.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<InboundNatRule> createOrUpdateAsync(
        String resourceGroupName,
        String loadBalancerName,
        String inboundNatRuleName,
        InboundNatRule inboundNatRuleParameters) {
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String loadBalancerName, String inboundNatRuleName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, loadBalancerName, inboundNatRuleName)
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String loadBalancerName, String inboundNatRuleName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, loadBalancerName, inboundNatRuleName).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String loadBalancerName, String inboundNatRuleName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, loadBalancerName, inboundNatRuleName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<InboundNatRule>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String loadBalancerName,
        String inboundNatRuleName,
        InboundNatRule inboundNatRuleParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<InboundNatRule> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String loadBalancerName,
        String inboundNatRuleName,
        InboundNatRule inboundNatRuleParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<InboundNatRule>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<InboundNatRule>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
