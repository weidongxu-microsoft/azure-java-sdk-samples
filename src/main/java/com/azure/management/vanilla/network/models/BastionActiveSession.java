...
public final class BastionActiveSession {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BastionActiveSession.class);
     ...
     */
    public BastionConnectProtocol getProtocol() {
     ...
     */
    public Float getSessionDurationInMins() {
