...
public final class BastionActiveSessionListResult {
     ...
     */
    public List<BastionActiveSession> getValue() {
        return this.value;
    }
     ...
     */
    public BastionActiveSessionListResult setValue(List<BastionActiveSession> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the BastionActiveSessionListResult object itself.
     */
    public BastionActiveSessionListResult setNextLink(String nextLink) {
