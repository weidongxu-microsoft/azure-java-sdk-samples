...
public final class ExpressRouteCircuitRoutesTable {
     ...
     */
    public ExpressRouteCircuitRoutesTable setNetwork(String network) {
     ...
     * @return the ExpressRouteCircuitRoutesTable object itself.
     */
    public ExpressRouteCircuitRoutesTable setNextHop(String nextHop) {
     ...
     * @return the ExpressRouteCircuitRoutesTable object itself.
     */
    public ExpressRouteCircuitRoutesTable setLocPrf(String locPrf) {
        this.locPrf = locPrf;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTable object itself.
     */
    public ExpressRouteCircuitRoutesTable setWeight(Integer weight) {
        this.weight = weight;
        return this;
    }
     ...
     * @return the ExpressRouteCircuitRoutesTable object itself.
     */
    public ExpressRouteCircuitRoutesTable setPath(String path) {
        this.path = path;
        return this;
    }
