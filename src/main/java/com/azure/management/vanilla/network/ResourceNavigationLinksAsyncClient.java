...
public final class ResourceNavigationLinksAsyncClient {
    private ResourceNavigationLinksImpl serviceClient;

    /** Initializes an instance of ResourceNavigationLinks client. */
    ResourceNavigationLinksAsyncClient(ResourceNavigationLinksImpl serviceClient) {
    ...
    public Mono<Response<ResourceNavigationLinksListResult>> listWithResponse(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceNavigationLinksListResult> list(
        String resourceGroupName, String virtualNetworkName, String subnetName) {
