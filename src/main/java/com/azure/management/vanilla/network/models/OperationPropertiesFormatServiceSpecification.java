...
public final class OperationPropertiesFormatServiceSpecification {
     ...
     */
    public OperationPropertiesFormatServiceSpecification setMetricSpecifications(
     ...
     * @return the OperationPropertiesFormatServiceSpecification object itself.
     */
    public OperationPropertiesFormatServiceSpecification setLogSpecifications(
    ...
    public void validate() {
        if (getMetricSpecifications() != null) {
            getMetricSpecifications().forEach(e -> e.validate());
        }
        if (getLogSpecifications() != null) {
            getLogSpecifications().forEach(e -> e.validate());
        }
    }
}
