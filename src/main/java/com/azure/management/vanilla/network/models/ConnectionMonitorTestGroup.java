...
public final class ConnectionMonitorTestGroup {
     ...
     */
    public ConnectionMonitorTestGroup setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ConnectionMonitorTestGroup object itself.
     */
    public ConnectionMonitorTestGroup setDisable(Boolean disable) {
     ...
     * @return the ConnectionMonitorTestGroup object itself.
     */
    public ConnectionMonitorTestGroup setTestConfigurations(List<String> testConfigurations) {
     ...
     * @return the ConnectionMonitorTestGroup object itself.
     */
    public ConnectionMonitorTestGroup setSources(List<String> sources) {
     ...
     * @return the ConnectionMonitorTestGroup object itself.
     */
    public ConnectionMonitorTestGroup setDestinations(List<String> destinations) {
