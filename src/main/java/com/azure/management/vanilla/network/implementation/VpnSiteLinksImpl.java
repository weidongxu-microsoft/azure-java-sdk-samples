...
import com.azure.management.vanilla.network.models.ListVpnSiteLinksResult;
...
public final class VpnSiteLinksImpl {
    private final ClientLogger logger = new ClientLogger(VpnSiteLinksImpl.class);
    ...
    /**
     * Initializes an instance of VpnSiteLinksImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VpnSiteLinksImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    public Mono<Response<VpnSiteLink>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpnSiteLink> getAsync(String resourceGroupName, String vpnSiteName, String vpnSiteLinkName) {
        return getWithResponseAsync(resourceGroupName, vpnSiteName, vpnSiteLinkName)
            .flatMap(
                (Response<VpnSiteLink> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VpnSiteLink> getAsync(
        String resourceGroupName, String vpnSiteName, String vpnSiteLinkName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLink>> listByVpnSiteSinglePageAsync(String resourceGroupName, String vpnSiteName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLink>> listByVpnSiteSinglePageAsync(
    ...
    public PagedFlux<VpnSiteLink> listByVpnSiteAsync(String resourceGroupName, String vpnSiteName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VpnSiteLink> listByVpnSiteAsync(String resourceGroupName, String vpnSiteName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLink>> listByVpnSiteNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLink>> listByVpnSiteNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
