...
public final class VpnServerConfigRadiusClientRootCertificate {
     ...
     */
    public VpnServerConfigRadiusClientRootCertificate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VpnServerConfigRadiusClientRootCertificate object itself.
     */
    public VpnServerConfigRadiusClientRootCertificate setThumbprint(String thumbprint) {
