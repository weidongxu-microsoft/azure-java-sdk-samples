...
@Immutable
public final class ConnectivityInformation {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ConnectivityInformation.class);
