...
@JsonFlatten
@Fluent
public class ConnectionMonitorResult extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ConnectionMonitorResult.class);
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setSource(ConnectionMonitorSource source) {
        this.source = source;
        return this;
    }
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setDestination(ConnectionMonitorDestination destination) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setAutoStart(Boolean autoStart) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setMonitoringIntervalInSeconds(Integer monitoringIntervalInSeconds) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setEndpoints(List<ConnectionMonitorEndpoint> endpoints) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setTestConfigurations(List<ConnectionMonitorTestConfiguration> testConfigurations) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setTestGroups(List<ConnectionMonitorTestGroup> testGroups) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setOutputs(List<ConnectionMonitorOutput> outputs) {
     ...
     * @return the ConnectionMonitorResult object itself.
     */
    public ConnectionMonitorResult setNotes(String notes) {
        this.notes = notes;
        return this;
    }
     ...
     */
    public ConnectionMonitorType getConnectionMonitorType() {
