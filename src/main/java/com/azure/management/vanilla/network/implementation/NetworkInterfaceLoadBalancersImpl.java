...
import com.azure.management.vanilla.network.models.NetworkInterfaceLoadBalancerListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in NetworkInterfaceLoadBalancers. */
public final class NetworkInterfaceLoadBalancersImpl {
    private final ClientLogger logger = new ClientLogger(NetworkInterfaceLoadBalancersImpl.class);
    ...
    /**
     * Initializes an instance of NetworkInterfaceLoadBalancersImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    NetworkInterfaceLoadBalancersImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    public PagedFlux<LoadBalancer> listAsync(String resourceGroupName, String networkInterfaceName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<LoadBalancer> listAsync(String resourceGroupName, String networkInterfaceName, Context context) {
        return new PagedFlux<>(
