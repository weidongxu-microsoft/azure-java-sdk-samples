...
public final class DdosCustomPoliciesImpl implements InnerSupportsGet<DdosCustomPolicy>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(DdosCustomPoliciesImpl.class);
    ...
    /**
     * Initializes an instance of DdosCustomPoliciesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DdosCustomPoliciesImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface DdosCustomPoliciesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DdosCustomPolicy>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName,
            @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") DdosCustomPolicy parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DdosCustomPolicy>> updateTags(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DdosCustomPolicy>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("ddosCustomPolicyName") String ddosCustomPolicyName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> deleteAsync(String resourceGroupName, String ddosCustomPolicyName, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            deleteWithResponseAsync(resourceGroupName, ddosCustomPolicyName, context);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DdosCustomPolicy>> getByResourceGroupWithResponseAsync(
        String resourceGroupName, String ddosCustomPolicyName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DdosCustomPolicy> getByResourceGroupAsync(String resourceGroupName, String ddosCustomPolicyName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, ddosCustomPolicyName)
            .flatMap(
                (Response<DdosCustomPolicy> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DdosCustomPolicy> getByResourceGroupAsync(
        String resourceGroupName, String ddosCustomPolicyName, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, ddosCustomPolicyName, context)
            .flatMap(
                (Response<DdosCustomPolicy> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public DdosCustomPolicy getByResourceGroup(String resourceGroupName, String ddosCustomPolicyName, Context context) {
        return getByResourceGroupAsync(resourceGroupName, ddosCustomPolicyName, context).block();
    }
    ...
    public PollerFlux<PollResult<DdosCustomPolicy>, DdosCustomPolicy> beginCreateOrUpdate(
        ...
        return this
            .client
            .<DdosCustomPolicy, DdosCustomPolicy>getLroResultAsync(
                mono, this.client.getHttpPipeline(), DdosCustomPolicy.class, DdosCustomPolicy.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DdosCustomPolicy> createOrUpdateAsync(
        String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicy parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, ddosCustomPolicyName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DdosCustomPolicy>> updateTagsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DdosCustomPolicy> updateTagsAsync(
        String resourceGroupName, String ddosCustomPolicyName, Map<String, String> tags) {
    ...
    public Mono<DdosCustomPolicy> updateTagsAsync(
        String resourceGroupName, String ddosCustomPolicyName, Map<String, String> tags, Context context) {
        return updateTagsWithResponseAsync(resourceGroupName, ddosCustomPolicyName, tags, context)
            .flatMap(
                (Response<DdosCustomPolicy> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public DdosCustomPolicy updateTags(
        String resourceGroupName, String ddosCustomPolicyName, Map<String, String> tags, Context context) {
        return updateTagsAsync(resourceGroupName, ddosCustomPolicyName, tags, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String ddosCustomPolicyName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, ddosCustomPolicyName)
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String ddosCustomPolicyName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, ddosCustomPolicyName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String ddosCustomPolicyName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, ddosCustomPolicyName).block();
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String ddosCustomPolicyName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, ddosCustomPolicyName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DdosCustomPolicy>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicy parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DdosCustomPolicy> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicy parameters) {
        return beginCreateOrUpdateWithoutPollingWithResponseAsync(resourceGroupName, ddosCustomPolicyName, parameters)
            .flatMap(
                (Response<DdosCustomPolicy> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public DdosCustomPolicy beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicy parameters) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, ddosCustomPolicyName, parameters).block();
    }
    ...
    public DdosCustomPolicy beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String ddosCustomPolicyName, DdosCustomPolicy parameters, Context context) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, ddosCustomPolicyName, parameters, context)
            .block();
    }
}
