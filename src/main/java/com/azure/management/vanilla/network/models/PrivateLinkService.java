...
@JsonFlatten
@Fluent
public class PrivateLinkService extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(PrivateLinkService.class);
    ...
    private List<FrontendIpConfiguration> loadBalancerFrontendIpConfigurations;
     ...
     */
    public List<FrontendIpConfiguration> getLoadBalancerFrontendIpConfigurations() {
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setLoadBalancerFrontendIpConfigurations(
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setIpConfigurations(List<PrivateLinkServiceIpConfiguration> ipConfigurations) {
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setVisibility(ResourceSet visibility) {
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setAutoApproval(ResourceSet autoApproval) {
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setFqdns(List<String> fqdns) {
        this.fqdns = fqdns;
        return this;
    }
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setEnableProxyProtocol(Boolean enableProxyProtocol) {
     ...
     * @return the PrivateLinkService object itself.
     */
    public PrivateLinkService setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
        if (getLoadBalancerFrontendIpConfigurations() != null) {
            getLoadBalancerFrontendIpConfigurations().forEach(e -> e.validate());
        }
        ...
        if (getVisibility() != null) {
            getVisibility().validate();
        }
        if (getAutoApproval() != null) {
            getAutoApproval().validate();
        }
    }
}
