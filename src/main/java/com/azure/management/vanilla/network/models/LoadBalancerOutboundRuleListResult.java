...
/** The LoadBalancerOutboundRuleListResult model. */
@Fluent
public final class LoadBalancerOutboundRuleListResult {
    ...
    private List<OutboundRule> value;
     ...
     */
    public List<OutboundRule> getValue() {
        return this.value;
    }
     ...
     */
    public LoadBalancerOutboundRuleListResult setValue(List<OutboundRule> value) {
        this.value = value;
        return this;
    }
