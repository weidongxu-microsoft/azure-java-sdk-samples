...
import com.azure.management.vanilla.network.models.VirtualNetworkListResult;
import com.azure.management.vanilla.network.models.VirtualNetworkListUsageResult;
...
public final class VirtualNetworksImpl
    implements InnerSupportsGet<VirtualNetwork>, InnerSupportsListing<VirtualNetwork>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(VirtualNetworksImpl.class);
    ...
    /**
     * Initializes an instance of VirtualNetworksImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VirtualNetworksImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface VirtualNetworksService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetwork>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
            @QueryParam("api-version") String apiVersion,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") VirtualNetwork parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetwork>> updateTags(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<IpAddressAvailabilityResult>> checkIpAddressAvailability(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualNetwork>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualNetworkName") String virtualNetworkName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualNetwork>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetwork> getByResourceGroupAsync(String resourceGroupName, String virtualNetworkName) {
    ...
    public PollerFlux<PollResult<VirtualNetwork>, VirtualNetwork> beginCreateOrUpdate(
        ...
        return this
            .client
            .<VirtualNetwork, VirtualNetwork>getLroResultAsync(
                mono, this.client.getHttpPipeline(), VirtualNetwork.class, VirtualNetwork.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetwork> createOrUpdateAsync(
        String resourceGroupName, String virtualNetworkName, VirtualNetwork parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, virtualNetworkName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualNetwork>> updateTagsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetwork> updateTagsAsync(
        String resourceGroupName, String virtualNetworkName, Map<String, String> tags) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
        ...
        return FluxUtil
            ...
            .<PagedResponse<VirtualNetwork>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<VirtualNetwork> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetwork> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetwork> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetwork> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<IpAddressAvailabilityResult>> checkIpAddressAvailabilityWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<IpAddressAvailabilityResult> checkIpAddressAvailabilityAsync(
        String resourceGroupName, String virtualNetworkName, String ipAddress) {
        return checkIpAddressAvailabilityWithResponseAsync(resourceGroupName, virtualNetworkName, ipAddress)
            .flatMap(
                (Response<IpAddressAvailabilityResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkUsage>> listUsageSinglePageAsync(
        String resourceGroupName, String virtualNetworkName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
                ...
                context ->
                    service
                        .listUsage(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<VirtualNetworkUsage>>map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
                        res.getStatusCode(),
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetworkUsage> listUsageAsync(String resourceGroupName, String virtualNetworkName) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualNetworkUsage> listUsageAsync(
        String resourceGroupName, String virtualNetworkName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String virtualNetworkName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, virtualNetworkName)
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String virtualNetworkName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, virtualNetworkName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String virtualNetworkName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, virtualNetworkName).block();
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String virtualNetworkName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, virtualNetworkName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualNetwork>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String virtualNetworkName, VirtualNetwork parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualNetwork> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String virtualNetworkName, VirtualNetwork parameters) {
        return beginCreateOrUpdateWithoutPollingWithResponseAsync(resourceGroupName, virtualNetworkName, parameters)
            .flatMap(
                (Response<VirtualNetwork> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public VirtualNetwork beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String virtualNetworkName, VirtualNetwork parameters) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, virtualNetworkName, parameters).block();
    }
    ...
    public VirtualNetwork beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String virtualNetworkName, VirtualNetwork parameters, Context context) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, virtualNetworkName, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listAllNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listAllNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetwork>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkUsage>> listUsageNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualNetworkUsage>> listUsageNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
