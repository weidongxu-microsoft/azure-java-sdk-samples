...
import com.azure.management.vanilla.network.models.LoadBalancerFrontendIpConfigurationListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in LoadBalancerFrontendIpConfigurations. */
public final class LoadBalancerFrontendIpConfigurationsImpl {
    private final ClientLogger logger = new ClientLogger(LoadBalancerFrontendIpConfigurationsImpl.class);
    ...
    /**
     * Initializes an instance of LoadBalancerFrontendIpConfigurationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    LoadBalancerFrontendIpConfigurationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface LoadBalancerFrontendIpConfigurationsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FrontendIpConfiguration>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
    ...
    public Mono<PagedResponse<FrontendIpConfiguration>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            context))
            .<PagedResponse<FrontendIpConfiguration>>map(
                res ->
    ...
    public PagedFlux<FrontendIpConfiguration> listAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FrontendIpConfiguration> listAsync(
        String resourceGroupName, String loadBalancerName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FrontendIpConfiguration>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FrontendIpConfiguration>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FrontendIpConfiguration>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
