...
public final class ListVpnSiteLinkConnectionsResult {
    ...
    private List<VpnSiteLinkConnection> value;
     ...
     */
    public List<VpnSiteLinkConnection> getValue() {
        return this.value;
    }
     ...
     */
    public ListVpnSiteLinkConnectionsResult setValue(List<VpnSiteLinkConnection> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ListVpnSiteLinkConnectionsResult object itself.
     */
    public ListVpnSiteLinkConnectionsResult setNextLink(String nextLink) {
