...
public final class TrafficAnalyticsProperties {
     ...
     */
    public TrafficAnalyticsProperties setNetworkWatcherFlowAnalyticsConfiguration(
    ...
    public void validate() {
        if (getNetworkWatcherFlowAnalyticsConfiguration() != null) {
            getNetworkWatcherFlowAnalyticsConfiguration().validate();
        }
    }
}
