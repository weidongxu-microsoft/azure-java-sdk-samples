...
@JsonFlatten
@Fluent
public class RouteFilterRule extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(RouteFilterRule.class);
     ...
     * @return the RouteFilterRule object itself.
     */
    public RouteFilterRule setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the RouteFilterRule object itself.
     */
    public RouteFilterRule setLocation(String location) {
     ...
     * @return the RouteFilterRule object itself.
     */
    public RouteFilterRule setAccess(Access access) {
        this.access = access;
        return this;
    }
     ...
     * @return the RouteFilterRule object itself.
     */
    public RouteFilterRule setRouteFilterRuleType(RouteFilterRuleType routeFilterRuleType) {
     ...
     * @return the RouteFilterRule object itself.
     */
    public RouteFilterRule setCommunities(List<String> communities) {
