...
public class VirtualNetworkGatewayConnection extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VirtualNetworkGatewayConnection.class);
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setAuthorizationKey(String authorizationKey) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setVirtualNetworkGateway1(VirtualNetworkGateway virtualNetworkGateway1) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setVirtualNetworkGateway2(VirtualNetworkGateway virtualNetworkGateway2) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setLocalNetworkGateway2(LocalNetworkGateway localNetworkGateway2) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setConnectionType(VirtualNetworkGatewayConnectionType connectionType) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setConnectionProtocol(
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setRoutingWeight(Integer routingWeight) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setDpdTimeoutSeconds(Integer dpdTimeoutSeconds) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setSharedKey(String sharedKey) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setPeer(SubResource peer) {
        this.peer = peer;
        return this;
    }
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setEnableBgp(Boolean enableBgp) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setUseLocalAzureIpAddress(Boolean useLocalAzureIpAddress) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setUsePolicyBasedTrafficSelectors(Boolean usePolicyBasedTrafficSelectors) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setIpsecPolicies(List<IpsecPolicy> ipsecPolicies) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setTrafficSelectorPolicies(
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setExpressRouteGatewayBypass(Boolean expressRouteGatewayBypass) {
     ...
     * @return the VirtualNetworkGatewayConnection object itself.
     */
    public VirtualNetworkGatewayConnection setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property virtualNetworkGateway1 in model VirtualNetworkGatewayConnection"));
        } else {
        ...
        if (getConnectionType() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property connectionType in model VirtualNetworkGatewayConnection"));
        }
