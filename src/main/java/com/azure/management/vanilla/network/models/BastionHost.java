...
@JsonFlatten
@Fluent
public class BastionHost extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BastionHost.class);
     ...
     * @return the BastionHost object itself.
     */
    public BastionHost setIpConfigurations(List<BastionHostIpConfiguration> ipConfigurations) {
     ...
     * @return the BastionHost object itself.
     */
    public BastionHost setDnsName(String dnsName) {
     ...
     * @return the BastionHost object itself.
     */
    public BastionHost setId(String id) {
        this.id = id;
        return this;
    }
