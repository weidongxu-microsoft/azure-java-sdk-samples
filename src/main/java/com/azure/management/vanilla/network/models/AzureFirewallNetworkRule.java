...
public final class AzureFirewallNetworkRule {
     ...
     * @return the AzureFirewallNetworkRule object itself.
     */
    public AzureFirewallNetworkRule setDestinationFqdns(List<String> destinationFqdns) {
     ...
     * @return the AzureFirewallNetworkRule object itself.
     */
    public AzureFirewallNetworkRule setSourceIpGroups(List<String> sourceIpGroups) {
     ...
     * @return the AzureFirewallNetworkRule object itself.
     */
    public AzureFirewallNetworkRule setDestinationIpGroups(List<String> destinationIpGroups) {
