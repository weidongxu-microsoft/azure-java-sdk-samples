...
import com.azure.management.vanilla.network.models.ListVpnSiteLinkConnectionsResult;
...
public final class VpnLinkConnectionsImpl {
    private final ClientLogger logger = new ClientLogger(VpnLinkConnectionsImpl.class);
    ...
    /**
     * Initializes an instance of VpnLinkConnectionsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VpnLinkConnectionsImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    public Mono<PagedResponse<VpnSiteLinkConnection>> listByVpnConnectionSinglePageAsync(
                ...
                context ->
                    service
                        .listByVpnConnection(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<VpnSiteLinkConnection>>map(
                res ->
    ...
    public PagedFlux<VpnSiteLinkConnection> listByVpnConnectionAsync(
        String resourceGroupName, String gatewayName, String connectionName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLinkConnection>> listByVpnConnectionNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VpnSiteLinkConnection>> listByVpnConnectionNextSinglePageAsync(
