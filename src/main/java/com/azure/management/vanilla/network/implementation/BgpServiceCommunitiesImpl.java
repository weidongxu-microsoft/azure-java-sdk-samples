...
import com.azure.management.vanilla.network.models.BgpServiceCommunityListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in BgpServiceCommunities. */
public final class BgpServiceCommunitiesImpl {
    private final ClientLogger logger = new ClientLogger(BgpServiceCommunitiesImpl.class);
    ...
    /**
     * Initializes an instance of BgpServiceCommunitiesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    BgpServiceCommunitiesImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    public Mono<PagedResponse<BgpServiceCommunity>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<BgpServiceCommunity>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<BgpServiceCommunity>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<BgpServiceCommunity> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<BgpServiceCommunity> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<BgpServiceCommunity>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<BgpServiceCommunity>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
