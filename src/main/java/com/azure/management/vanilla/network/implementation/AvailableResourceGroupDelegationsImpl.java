...
import com.azure.management.vanilla.network.models.AvailableDelegationsResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in AvailableResourceGroupDelegations. */
public final class AvailableResourceGroupDelegationsImpl {
    private final ClientLogger logger = new ClientLogger(AvailableResourceGroupDelegationsImpl.class);
    ...
    /**
     * Initializes an instance of AvailableResourceGroupDelegationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    AvailableResourceGroupDelegationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    public Mono<PagedResponse<AvailableDelegation>> listSinglePageAsync(String location, String resourceGroupName) {
                ...
                context ->
                    service
                        .list(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<AvailableDelegation>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<AvailableDelegation>> listSinglePageAsync(
    ...
    public PagedFlux<AvailableDelegation> listAsync(String location, String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<AvailableDelegation> listAsync(String location, String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<AvailableDelegation>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<AvailableDelegation>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
