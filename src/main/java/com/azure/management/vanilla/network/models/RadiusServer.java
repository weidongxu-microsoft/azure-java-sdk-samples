...
public final class RadiusServer {
     ...
     */
    public RadiusServer setRadiusServerAddress(String radiusServerAddress) {
     ...
     */
    public Long getRadiusServerScore() {
     ...
     * @return the RadiusServer object itself.
     */
    public RadiusServer setRadiusServerScore(Long radiusServerScore) {
     ...
     * @return the RadiusServer object itself.
     */
    public RadiusServer setRadiusServerSecret(String radiusServerSecret) {
    ...
    public void validate() {
        if (getRadiusServerAddress() == null) {
            throw logger
                .logExceptionAsError(
