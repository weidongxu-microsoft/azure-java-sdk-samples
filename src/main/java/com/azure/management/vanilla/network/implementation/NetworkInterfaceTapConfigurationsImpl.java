...
import com.azure.management.vanilla.network.models.NetworkInterfaceTapConfigurationListResult;
...
public final class NetworkInterfaceTapConfigurationsImpl {
    private final ClientLogger logger = new ClientLogger(NetworkInterfaceTapConfigurationsImpl.class);
    ...
    /**
     * Initializes an instance of NetworkInterfaceTapConfigurationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    NetworkInterfaceTapConfigurationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface NetworkInterfaceTapConfigurationsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceTapConfiguration>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @PathParam("tapConfigurationName") String tapConfigurationName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") NetworkInterfaceTapConfiguration tapConfigurationParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<NetworkInterfaceTapConfiguration>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("networkInterfaceName") String networkInterfaceName,
            @PathParam("tapConfigurationName") String tapConfigurationName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<NetworkInterfaceTapConfiguration>> getWithResponseAsync(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<NetworkInterfaceTapConfiguration> getAsync(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        return getWithResponseAsync(resourceGroupName, networkInterfaceName, tapConfigurationName)
            .flatMap(
                (Response<NetworkInterfaceTapConfiguration> res) -> {
    ...
    public Mono<NetworkInterfaceTapConfiguration> getAsync(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName, Context context) {
        return getWithResponseAsync(resourceGroupName, networkInterfaceName, tapConfigurationName, context)
            .flatMap(
                (Response<NetworkInterfaceTapConfiguration> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public NetworkInterfaceTapConfiguration get(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName, Context context) {
        return getAsync(resourceGroupName, networkInterfaceName, tapConfigurationName, context).block();
    }
    ...
    public PollerFlux<PollResult<NetworkInterfaceTapConfiguration>, NetworkInterfaceTapConfiguration>
        ...
        return this
            .client
            .<NetworkInterfaceTapConfiguration, NetworkInterfaceTapConfiguration>getLroResultAsync(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<NetworkInterfaceTapConfiguration> createOrUpdateAsync(
        String resourceGroupName,
        String networkInterfaceName,
        String tapConfigurationName,
        NetworkInterfaceTapConfiguration tapConfigurationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<NetworkInterfaceTapConfiguration>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<NetworkInterfaceTapConfiguration>>map(
                res ->
    ...
    public PagedFlux<NetworkInterfaceTapConfiguration> listAsync(
        String resourceGroupName, String networkInterfaceName) {
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, networkInterfaceName, tapConfigurationName)
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, networkInterfaceName, tapConfigurationName).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String networkInterfaceName, String tapConfigurationName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, networkInterfaceName, tapConfigurationName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<NetworkInterfaceTapConfiguration>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String networkInterfaceName,
        String tapConfigurationName,
        NetworkInterfaceTapConfiguration tapConfigurationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<NetworkInterfaceTapConfiguration> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String networkInterfaceName,
        String tapConfigurationName,
        NetworkInterfaceTapConfiguration tapConfigurationParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<NetworkInterfaceTapConfiguration>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<NetworkInterfaceTapConfiguration>> listNextSinglePageAsync(
