...
public class ResourceNavigationLink extends SubResource {
     ...
     */
    public ResourceNavigationLink setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ResourceNavigationLink object itself.
     */
    public ResourceNavigationLink setLinkedResourceType(String linkedResourceType) {
     ...
     * @return the ResourceNavigationLink object itself.
     */
    public ResourceNavigationLink setLink(String link) {
        this.link = link;
        return this;
    }
