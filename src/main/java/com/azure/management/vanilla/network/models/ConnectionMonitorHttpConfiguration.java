...
public final class ConnectionMonitorHttpConfiguration {
     ...
     */
    public ConnectionMonitorHttpConfiguration setPort(Integer port) {
        this.port = port;
        return this;
    }
     ...
     */
    public HttpConfigurationMethod getMethod() {
        return this.method;
    }
     ...
     * @return the ConnectionMonitorHttpConfiguration object itself.
     */
    public ConnectionMonitorHttpConfiguration setMethod(HttpConfigurationMethod method) {
        this.method = method;
        return this;
    }
     ...
     * @return the ConnectionMonitorHttpConfiguration object itself.
     */
    public ConnectionMonitorHttpConfiguration setPath(String path) {
        this.path = path;
        return this;
    }
     ...
     * @return the ConnectionMonitorHttpConfiguration object itself.
     */
    public ConnectionMonitorHttpConfiguration setRequestHeaders(List<HttpHeader> requestHeaders) {
     ...
     * @return the ConnectionMonitorHttpConfiguration object itself.
     */
    public ConnectionMonitorHttpConfiguration setValidStatusCodeRanges(List<String> validStatusCodeRanges) {
     ...
     * @return the ConnectionMonitorHttpConfiguration object itself.
     */
    public ConnectionMonitorHttpConfiguration setPreferHttps(Boolean preferHttps) {
    ...
    public void validate() {
        if (getRequestHeaders() != null) {
            getRequestHeaders().forEach(e -> e.validate());
        }
    }
}
