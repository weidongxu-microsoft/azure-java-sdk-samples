...
import com.azure.management.vanilla.network.models.LoadBalancerLoadBalancingRuleListResult;
...
public final class LoadBalancerLoadBalancingRulesImpl {
    private final ClientLogger logger = new ClientLogger(LoadBalancerLoadBalancingRulesImpl.class);
    ...
    /**
     * Initializes an instance of LoadBalancerLoadBalancingRulesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    LoadBalancerLoadBalancingRulesImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface LoadBalancerLoadBalancingRulesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LoadBalancingRule>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
    ...
    public Mono<PagedResponse<LoadBalancingRule>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            context))
            .<PagedResponse<LoadBalancingRule>>map(
                res ->
    ...
    public PagedFlux<LoadBalancingRule> listAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<LoadBalancingRule> listAsync(String resourceGroupName, String loadBalancerName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<LoadBalancingRule>> getWithResponseAsync(
    ...
    public Mono<LoadBalancingRule> getAsync(
        String resourceGroupName, String loadBalancerName, String loadBalancingRuleName, Context context) {
        return getWithResponseAsync(resourceGroupName, loadBalancerName, loadBalancingRuleName, context)
            .flatMap(
                (Response<LoadBalancingRule> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public LoadBalancingRule get(
        String resourceGroupName, String loadBalancerName, String loadBalancingRuleName, Context context) {
        return getAsync(resourceGroupName, loadBalancerName, loadBalancingRuleName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<LoadBalancingRule>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<LoadBalancingRule>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
