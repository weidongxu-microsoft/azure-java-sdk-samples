...
public class ApplicationGatewayAuthenticationCertificate extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ApplicationGatewayAuthenticationCertificate.class);
     ...
     */
    public ApplicationGatewayAuthenticationCertificate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the ApplicationGatewayAuthenticationCertificate object itself.
     */
    public ApplicationGatewayAuthenticationCertificate setData(String data) {
        this.data = data;
        return this;
    }
