...
public final class PublicIpPrefixListResult {
    ...
    private List<PublicIpPrefix> value;
     ...
     */
    public PublicIpPrefixListResult setValue(List<PublicIpPrefix> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the PublicIpPrefixListResult object itself.
     */
    public PublicIpPrefixListResult setNextLink(String nextLink) {
