...
import com.azure.management.vanilla.network.models.FirewallPolicyRuleGroupListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in FirewallPolicyRuleGroups. */
public final class FirewallPolicyRuleGroupsImpl {
    private final ClientLogger logger = new ClientLogger(FirewallPolicyRuleGroupsImpl.class);
    ...
    /**
     * Initializes an instance of FirewallPolicyRuleGroupsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    FirewallPolicyRuleGroupsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    private interface FirewallPolicyRuleGroupsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyRuleGroup>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleGroupName") String ruleGroupName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") FirewallPolicyRuleGroup parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyRuleGroupListResult>> list(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyRuleGroup>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("firewallPolicyName") String firewallPolicyName,
            @PathParam("ruleGroupName") String ruleGroupName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FirewallPolicyRuleGroupListResult>> listNext(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FirewallPolicyRuleGroup>> getWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FirewallPolicyRuleGroup> getAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName) {
        return getWithResponseAsync(resourceGroupName, firewallPolicyName, ruleGroupName)
            .flatMap(
                (Response<FirewallPolicyRuleGroup> res) -> {
    ...
    public PollerFlux<PollResult<FirewallPolicyRuleGroup>, FirewallPolicyRuleGroup> beginCreateOrUpdate(
        ...
        return this
            .client
            .<FirewallPolicyRuleGroup, FirewallPolicyRuleGroup>getLroResultAsync(
                mono, this.client.getHttpPipeline(), FirewallPolicyRuleGroup.class, FirewallPolicyRuleGroup.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FirewallPolicyRuleGroup> createOrUpdateAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName, FirewallPolicyRuleGroup parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, firewallPolicyName, ruleGroupName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FirewallPolicyRuleGroup>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<FirewallPolicyRuleGroup>>map(
                res ->
    ...
    public PagedFlux<FirewallPolicyRuleGroup> listAsync(String resourceGroupName, String firewallPolicyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FirewallPolicyRuleGroup> listAsync(
        String resourceGroupName, String firewallPolicyName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FirewallPolicyRuleGroup>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName, FirewallPolicyRuleGroup parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FirewallPolicyRuleGroup> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String firewallPolicyName, String ruleGroupName, FirewallPolicyRuleGroup parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FirewallPolicyRuleGroup>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FirewallPolicyRuleGroup>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
