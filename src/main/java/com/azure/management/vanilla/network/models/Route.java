...
public class Route extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(Route.class);
     ...
     * @return the Route object itself.
     */
    public Route setAddressPrefix(String addressPrefix) {
     ...
     * @return the Route object itself.
     */
    public Route setNextHopType(RouteNextHopType nextHopType) {
     ...
     * @return the Route object itself.
     */
    public Route setNextHopIpAddress(String nextHopIpAddress) {
