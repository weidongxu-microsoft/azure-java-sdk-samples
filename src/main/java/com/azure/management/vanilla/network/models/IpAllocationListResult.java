...
public final class IpAllocationListResult {
    ...
    private List<IpAllocation> value;
     ...
     */
    public List<IpAllocation> getValue() {
        return this.value;
    }
     ...
     */
    public IpAllocationListResult setValue(List<IpAllocation> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the IpAllocationListResult object itself.
     */
    public IpAllocationListResult setNextLink(String nextLink) {
