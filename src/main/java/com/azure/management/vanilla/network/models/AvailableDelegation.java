...
@Fluent
public final class AvailableDelegation {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AvailableDelegation.class);
     ...
     * @return the AvailableDelegation object itself.
     */
    public AvailableDelegation setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the AvailableDelegation object itself.
     */
    public AvailableDelegation setId(String id) {
        this.id = id;
        return this;
    }
     ...
     * @return the AvailableDelegation object itself.
     */
    public AvailableDelegation setType(String type) {
        this.type = type;
        return this;
    }
     ...
     * @return the AvailableDelegation object itself.
     */
    public AvailableDelegation setServiceName(String serviceName) {
     ...
     * @return the AvailableDelegation object itself.
     */
    public AvailableDelegation setActions(List<String> actions) {
