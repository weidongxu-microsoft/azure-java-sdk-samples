...
import com.azure.management.vanilla.network.models.ExpressRoutePortsLocationListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in ExpressRoutePortsLocations. */
public final class ExpressRoutePortsLocationsImpl {
    private final ClientLogger logger = new ClientLogger(ExpressRoutePortsLocationsImpl.class);
    ...
    /**
     * Initializes an instance of ExpressRoutePortsLocationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRoutePortsLocationsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface ExpressRoutePortsLocationsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRoutePortsLocation>> get(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<PagedResponse<ExpressRoutePortsLocation>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ExpressRoutePortsLocation>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRoutePortsLocation>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<ExpressRoutePortsLocation> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ExpressRoutePortsLocation> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRoutePortsLocation>> getWithResponseAsync(String locationName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .get(this.client.getHost(), this.client.getSubscriptionId(), apiVersion, locationName, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRoutePortsLocation>> getWithResponseAsync(String locationName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
        ...
        final String apiVersion = "2020-04-01";
        return service.get(this.client.getHost(), this.client.getSubscriptionId(), apiVersion, locationName, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRoutePortsLocation> getAsync(String locationName) {
        return getWithResponseAsync(locationName)
            .flatMap(
                (Response<ExpressRoutePortsLocation> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRoutePortsLocation> getAsync(String locationName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRoutePortsLocation>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRoutePortsLocation>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
