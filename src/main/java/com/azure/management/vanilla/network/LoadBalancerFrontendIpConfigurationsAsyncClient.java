...
public final class LoadBalancerFrontendIpConfigurationsAsyncClient {
    ...
    LoadBalancerFrontendIpConfigurationsAsyncClient(LoadBalancerFrontendIpConfigurationsImpl serviceClient) {
    ...
    public Mono<PagedResponse<FrontendIpConfiguration>> listSinglePage(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FrontendIpConfiguration> list(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FrontendIpConfiguration> list(String resourceGroupName, String loadBalancerName, Context context) {
    ...
    public Mono<Response<FrontendIpConfiguration>> getWithResponse(
        String resourceGroupName, String loadBalancerName, String frontendIpConfigurationName) {
        return this
            .serviceClient
            .getWithResponseAsync(resourceGroupName, loadBalancerName, frontendIpConfigurationName);
    }
    ...
    public Mono<Response<FrontendIpConfiguration>> getWithResponse(
        ...
        return this
            .serviceClient
            .getWithResponseAsync(resourceGroupName, loadBalancerName, frontendIpConfigurationName, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FrontendIpConfiguration> get(
        String resourceGroupName, String loadBalancerName, String frontendIpConfigurationName) {
        return this.serviceClient.getAsync(resourceGroupName, loadBalancerName, frontendIpConfigurationName);
    }
    ...
    public Mono<FrontendIpConfiguration> get(
        String resourceGroupName, String loadBalancerName, String frontendIpConfigurationName, Context context) {
        return this.serviceClient.getAsync(resourceGroupName, loadBalancerName, frontendIpConfigurationName, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public Mono<PagedResponse<FrontendIpConfiguration>> listNextSinglePage(String nextLink) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public Mono<PagedResponse<FrontendIpConfiguration>> listNextSinglePage(String nextLink, Context context) {
