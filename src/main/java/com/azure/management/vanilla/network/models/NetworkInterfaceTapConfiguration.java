...
@JsonFlatten
@Fluent
public class NetworkInterfaceTapConfiguration extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(NetworkInterfaceTapConfiguration.class);
    ...
    private VirtualNetworkTap virtualNetworkTap;
     ...
     * @return the NetworkInterfaceTapConfiguration object itself.
     */
    public NetworkInterfaceTapConfiguration setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    public VirtualNetworkTap getVirtualNetworkTap() {
     ...
     * @return the NetworkInterfaceTapConfiguration object itself.
     */
    public NetworkInterfaceTapConfiguration setVirtualNetworkTap(VirtualNetworkTap virtualNetworkTap) {
    ...
    public void validate() {
        if (getVirtualNetworkTap() != null) {
            getVirtualNetworkTap().validate();
        }
    }
}
