...
import com.azure.management.vanilla.network.models.LoadBalancerOutboundRuleListResult;
...
public final class LoadBalancerOutboundRulesImpl {
    private final ClientLogger logger = new ClientLogger(LoadBalancerOutboundRulesImpl.class);
    ...
    /**
     * Initializes an instance of LoadBalancerOutboundRulesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    LoadBalancerOutboundRulesImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface LoadBalancerOutboundRulesService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<OutboundRule>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("loadBalancerName") String loadBalancerName,
    ...
    public Mono<PagedResponse<OutboundRule>> listSinglePageAsync(String resourceGroupName, String loadBalancerName) {
                ...
                context ->
                    service
                        .list(
                            ...
                            context))
            .<PagedResponse<OutboundRule>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<OutboundRule>> listSinglePageAsync(
    ...
    public PagedFlux<OutboundRule> listAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<OutboundRule> listAsync(String resourceGroupName, String loadBalancerName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<OutboundRule>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<OutboundRule> getAsync(String resourceGroupName, String loadBalancerName, String outboundRuleName) {
        return getWithResponseAsync(resourceGroupName, loadBalancerName, outboundRuleName)
            .flatMap(
                (Response<OutboundRule> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<OutboundRule> getAsync(
        String resourceGroupName, String loadBalancerName, String outboundRuleName, Context context) {
        return getWithResponseAsync(resourceGroupName, loadBalancerName, outboundRuleName, context)
            .flatMap(
                (Response<OutboundRule> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public OutboundRule get(
        String resourceGroupName, String loadBalancerName, String outboundRuleName, Context context) {
        return getAsync(resourceGroupName, loadBalancerName, outboundRuleName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<OutboundRule>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<OutboundRule>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
