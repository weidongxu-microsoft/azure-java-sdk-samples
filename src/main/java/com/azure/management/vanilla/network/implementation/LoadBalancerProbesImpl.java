...
import com.azure.management.vanilla.network.models.LoadBalancerProbeListResult;
...
public final class LoadBalancerProbesImpl {
    private final ClientLogger logger = new ClientLogger(LoadBalancerProbesImpl.class);
    ...
    /**
     * Initializes an instance of LoadBalancerProbesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    LoadBalancerProbesImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    public Mono<PagedResponse<Probe>> listSinglePageAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Probe>> listSinglePageAsync(
    ...
    public PagedFlux<Probe> listAsync(String resourceGroupName, String loadBalancerName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Probe> listAsync(String resourceGroupName, String loadBalancerName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Probe>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Probe> getAsync(String resourceGroupName, String loadBalancerName, String probeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Probe> getAsync(String resourceGroupName, String loadBalancerName, String probeName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Probe>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Probe>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
