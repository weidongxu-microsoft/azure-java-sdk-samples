...
@JsonFlatten
@Fluent
public class AzureFirewall extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AzureFirewall.class);
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setApplicationRuleCollections(
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setNatRuleCollections(List<AzureFirewallNatRuleCollection> natRuleCollections) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setNetworkRuleCollections(List<AzureFirewallNetworkRuleCollection> networkRuleCollections) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setIpConfigurations(List<AzureFirewallIpConfiguration> ipConfigurations) {
     ...
     */
    public AzureFirewallIpConfiguration getManagementIpConfiguration() {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setManagementIpConfiguration(AzureFirewallIpConfiguration managementIpConfiguration) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setThreatIntelMode(AzureFirewallThreatIntelMode threatIntelMode) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setVirtualHub(SubResource virtualHub) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setFirewallPolicy(SubResource firewallPolicy) {
     ...
     */
    public List<AzureFirewallIpGroups> getIpGroups() {
     ...
     */
    public AzureFirewallSku getSku() {
        return this.sku;
    }
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setSku(AzureFirewallSku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setAdditionalProperties(Map<String, String> additionalProperties) {
     ...
     * @return the AzureFirewall object itself.
     */
    public AzureFirewall setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
        if (getApplicationRuleCollections() != null) {
            getApplicationRuleCollections().forEach(e -> e.validate());
        }
        if (getNatRuleCollections() != null) {
            getNatRuleCollections().forEach(e -> e.validate());
        }
        if (getNetworkRuleCollections() != null) {
            getNetworkRuleCollections().forEach(e -> e.validate());
        }
        if (getIpConfigurations() != null) {
            getIpConfigurations().forEach(e -> e.validate());
        }
        if (getManagementIpConfiguration() != null) {
            getManagementIpConfiguration().validate();
        }
        if (getHubIpAddresses() != null) {
            getHubIpAddresses().validate();
        }
        if (getIpGroups() != null) {
            getIpGroups().forEach(e -> e.validate());
        }
        if (getSku() != null) {
            getSku().validate();
        }
