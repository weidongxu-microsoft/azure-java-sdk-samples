...
public class ApplicationGatewayFirewallRuleSet extends Resource {
     ...
     */
    public ApplicationGatewayFirewallRuleSet setRuleSetType(String ruleSetType) {
     ...
     * @return the ApplicationGatewayFirewallRuleSet object itself.
     */
    public ApplicationGatewayFirewallRuleSet setRuleSetVersion(String ruleSetVersion) {
     ...
     * @return the ApplicationGatewayFirewallRuleSet object itself.
     */
    public ApplicationGatewayFirewallRuleSet setRuleGroups(List<ApplicationGatewayFirewallRuleGroup> ruleGroups) {
     ...
     * @return the ApplicationGatewayFirewallRuleSet object itself.
     */
    public ApplicationGatewayFirewallRuleSet setId(String id) {
        this.id = id;
        return this;
    }
    ...
    public void validate() {
        if (getRuleGroups() != null) {
            getRuleGroups().forEach(e -> e.validate());
        }
    }
}
