...
public final class VpnServerConfigVpnClientRevokedCertificate {
     ...
     */
    public VpnServerConfigVpnClientRevokedCertificate setName(String name) {
        this.name = name;
        return this;
    }
     ...
     * @return the VpnServerConfigVpnClientRevokedCertificate object itself.
     */
    public VpnServerConfigVpnClientRevokedCertificate setThumbprint(String thumbprint) {
