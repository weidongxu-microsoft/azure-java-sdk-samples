...
public class BackendAddressPool extends SubResource {
     ...
     */
    public List<LoadBalancerBackendAddress> getLoadBalancerBackendAddresses() {
     ...
     * @return the BackendAddressPool object itself.
     */
    public BackendAddressPool setLoadBalancerBackendAddresses(
     ...
     */
    public SubResource getOutboundRule() {
    ...
    public void validate() {
        ...
        if (getLoadBalancerBackendAddresses() != null) {
            getLoadBalancerBackendAddresses().forEach(e -> e.validate());
        }
    }
}
