...
public final class FirewallPolicyRuleConditionType extends ExpandableStringEnum<FirewallPolicyRuleConditionType> {
    ...
    /** Static value NatRuleCondition for FirewallPolicyRuleConditionType. */
    public static final FirewallPolicyRuleConditionType NAT_RULE_CONDITION = fromString("NatRuleCondition");
