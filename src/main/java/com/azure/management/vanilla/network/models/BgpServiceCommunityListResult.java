...
public final class BgpServiceCommunityListResult {
    ...
    private List<BgpServiceCommunity> value;
     ...
     */
    public BgpServiceCommunityListResult setValue(List<BgpServiceCommunity> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the BgpServiceCommunityListResult object itself.
     */
    public BgpServiceCommunityListResult setNextLink(String nextLink) {
