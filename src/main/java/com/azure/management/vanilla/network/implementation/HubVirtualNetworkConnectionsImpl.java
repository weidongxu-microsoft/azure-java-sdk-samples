...
import com.azure.management.vanilla.network.models.ListHubVirtualNetworkConnectionsResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in HubVirtualNetworkConnections. */
public final class HubVirtualNetworkConnectionsImpl {
    private final ClientLogger logger = new ClientLogger(HubVirtualNetworkConnectionsImpl.class);
    ...
    /**
     * Initializes an instance of HubVirtualNetworkConnectionsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    HubVirtualNetworkConnectionsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface HubVirtualNetworkConnectionsService {
        ...
        Mono<Response<HubVirtualNetworkConnection>> get(
    ...
    public Mono<Response<HubVirtualNetworkConnection>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<HubVirtualNetworkConnection> getAsync(
        String resourceGroupName, String virtualHubName, String connectionName) {
        return getWithResponseAsync(resourceGroupName, virtualHubName, connectionName)
            .flatMap(
                (Response<HubVirtualNetworkConnection> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<HubVirtualNetworkConnection>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<HubVirtualNetworkConnection>>map(
                res ->
    ...
    public PagedFlux<HubVirtualNetworkConnection> listAsync(String resourceGroupName, String virtualHubName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<HubVirtualNetworkConnection> listAsync(
        String resourceGroupName, String virtualHubName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<HubVirtualNetworkConnection>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<HubVirtualNetworkConnection>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
