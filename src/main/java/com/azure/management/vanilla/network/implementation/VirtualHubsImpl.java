...
import com.azure.management.vanilla.network.models.ListVirtualHubsResult;
...
public final class VirtualHubsImpl
    implements InnerSupportsGet<VirtualHub>, InnerSupportsListing<VirtualHub>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(VirtualHubsImpl.class);
    ...
    /**
     * Initializes an instance of VirtualHubsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VirtualHubsImpl(NetworkManagementClientImpl client) {
        this.service =
    ...
    private interface VirtualHubsService {
        ...
        Mono<Response<VirtualHub>> getByResourceGroup(
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @PathParam("virtualHubName") String virtualHubName,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") VirtualHub virtualHubParameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualHub>> updateTags(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualHub>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("virtualHubName") String virtualHubName,
    ...
    public Mono<Response<VirtualHub>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> getByResourceGroupAsync(String resourceGroupName, String virtualHubName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, virtualHubName)
            .flatMap(
                (Response<VirtualHub> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> getByResourceGroupAsync(String resourceGroupName, String virtualHubName, Context context) {
    ...
    public PollerFlux<PollResult<VirtualHub>, VirtualHub> beginCreateOrUpdate(
        ...
        return this
            .client
            .<VirtualHub, VirtualHub>getLroResultAsync(
                mono, this.client.getHttpPipeline(), VirtualHub.class, VirtualHub.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> createOrUpdateAsync(
        String resourceGroupName, String virtualHubName, VirtualHub virtualHubParameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, virtualHubName, virtualHubParameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualHub>> updateTagsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> updateTagsAsync(String resourceGroupName, String virtualHubName, Map<String, String> tags) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> updateTagsAsync(
        String resourceGroupName, String virtualHubName, Map<String, String> tags, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listByResourceGroupSinglePageAsync(
    ...
    public PagedFlux<VirtualHub> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualHub> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualHub> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualHub> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualHub>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String virtualHubName, VirtualHub virtualHubParameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualHub> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String virtualHubName, VirtualHub virtualHubParameters) {
    ...
    public VirtualHub beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String virtualHubName, VirtualHub virtualHubParameters) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, virtualHubName, virtualHubParameters).block();
    }
    ...
    public VirtualHub beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String virtualHubName, VirtualHub virtualHubParameters, Context context) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, virtualHubName, virtualHubParameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String virtualHubName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, virtualHubName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String virtualHubName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, virtualHubName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String virtualHubName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, virtualHubName).block();
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String virtualHubName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, virtualHubName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listByResourceGroupNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualHub>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
