...
import com.azure.management.vanilla.network.models.ExpressRouteCircuitPeeringListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in ExpressRouteCircuitPeerings. */
public final class ExpressRouteCircuitPeeringsImpl {
    private final ClientLogger logger = new ClientLogger(ExpressRouteCircuitPeeringsImpl.class);
    ...
    /**
     * Initializes an instance of ExpressRouteCircuitPeeringsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRouteCircuitPeeringsImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface ExpressRouteCircuitPeeringsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteCircuitPeering>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("circuitName") String circuitName,
            @PathParam("peeringName") String peeringName,
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ExpressRouteCircuitPeering peeringParameters,
            Context context);
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ExpressRouteCircuitPeering>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("circuitName") String circuitName,
            @PathParam("peeringName") String peeringName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRouteCircuitPeering>> getWithResponseAsync(
        String resourceGroupName, String circuitName, String peeringName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitPeering> getAsync(String resourceGroupName, String circuitName, String peeringName) {
        return getWithResponseAsync(resourceGroupName, circuitName, peeringName)
            .flatMap(
                (Response<ExpressRouteCircuitPeering> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitPeering> getAsync(
        String resourceGroupName, String circuitName, String peeringName, Context context) {
    ...
    public PollerFlux<PollResult<ExpressRouteCircuitPeering>, ExpressRouteCircuitPeering> beginCreateOrUpdate(
        ...
        return this
            .client
            .<ExpressRouteCircuitPeering, ExpressRouteCircuitPeering>getLroResultAsync(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitPeering> createOrUpdateAsync(
        String resourceGroupName,
        String circuitName,
        String peeringName,
        ExpressRouteCircuitPeering peeringParameters) {
        ...
        return this
            .client
            .<ExpressRouteCircuitPeering, ExpressRouteCircuitPeering>getLroResultAsync(
                mono, this.client.getHttpPipeline(), ExpressRouteCircuitPeering.class, ExpressRouteCircuitPeering.class)
            .last()
            .flatMap(AsyncPollResponse::getFinalResult);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitPeering>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<ExpressRouteCircuitPeering>>map(
                res ->
    ...
    public PagedFlux<ExpressRouteCircuitPeering> listAsync(String resourceGroupName, String circuitName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ExpressRouteCircuitPeering>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String circuitName,
        String peeringName,
        ExpressRouteCircuitPeering peeringParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ExpressRouteCircuitPeering> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String circuitName,
        String peeringName,
        ExpressRouteCircuitPeering peeringParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitPeering>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteCircuitPeering>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
