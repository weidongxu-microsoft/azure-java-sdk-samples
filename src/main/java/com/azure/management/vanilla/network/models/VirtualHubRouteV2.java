...
public final class VirtualHubRouteV2 {
     ...
     */
    public VirtualHubRouteV2 setDestinationType(String destinationType) {
     ...
     * @return the VirtualHubRouteV2 object itself.
     */
    public VirtualHubRouteV2 setDestinations(List<String> destinations) {
     ...
     * @return the VirtualHubRouteV2 object itself.
     */
    public VirtualHubRouteV2 setNextHopType(String nextHopType) {
     ...
     * @return the VirtualHubRouteV2 object itself.
     */
    public VirtualHubRouteV2 setNextHops(List<String> nextHops) {
