...
public final class ApplicationGatewayUrlConfiguration {
     ...
     */
    public ApplicationGatewayUrlConfiguration setModifiedPath(String modifiedPath) {
     ...
     * @return the ApplicationGatewayUrlConfiguration object itself.
     */
    public ApplicationGatewayUrlConfiguration setModifiedQueryString(String modifiedQueryString) {
     ...
     * @return the ApplicationGatewayUrlConfiguration object itself.
     */
    public ApplicationGatewayUrlConfiguration setReroute(Boolean reroute) {
