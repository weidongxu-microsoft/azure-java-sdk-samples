...
public final class EffectiveNetworkSecurityGroup {
     ...
     */
    public EffectiveNetworkSecurityGroup setNetworkSecurityGroup(SubResource networkSecurityGroup) {
     ...
     * @return the EffectiveNetworkSecurityGroup object itself.
     */
    public EffectiveNetworkSecurityGroup setAssociation(EffectiveNetworkSecurityGroupAssociation association) {
     ...
     * @return the EffectiveNetworkSecurityGroup object itself.
     */
    public EffectiveNetworkSecurityGroup setEffectiveSecurityRules(
     ...
     * @return the EffectiveNetworkSecurityGroup object itself.
     */
    public EffectiveNetworkSecurityGroup setTagMap(String tagMap) {
        this.tagMap = tagMap;
        return this;
    }
