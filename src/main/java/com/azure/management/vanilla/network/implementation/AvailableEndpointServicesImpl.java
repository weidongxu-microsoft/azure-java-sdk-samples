...
import com.azure.management.vanilla.network.models.EndpointServicesListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in AvailableEndpointServices. */
public final class AvailableEndpointServicesImpl {
    private final ClientLogger logger = new ClientLogger(AvailableEndpointServicesImpl.class);
    ...
    /**
     * Initializes an instance of AvailableEndpointServicesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    AvailableEndpointServicesImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    public Mono<PagedResponse<EndpointServiceResult>> listSinglePageAsync(String location) {
        ...
        return FluxUtil
            ...
            .<PagedResponse<EndpointServiceResult>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EndpointServiceResult>> listSinglePageAsync(String location, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<EndpointServiceResult> listAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<EndpointServiceResult> listAsync(String location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EndpointServiceResult>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EndpointServiceResult>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
