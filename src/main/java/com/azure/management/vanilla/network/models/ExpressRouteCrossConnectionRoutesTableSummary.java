...
public final class ExpressRouteCrossConnectionRoutesTableSummary {
     ...
     */
    public ExpressRouteCrossConnectionRoutesTableSummary setNeighbor(String neighbor) {
     ...
     * @return the ExpressRouteCrossConnectionRoutesTableSummary object itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummary setAsn(Integer asn) {
        this.asn = asn;
        return this;
    }
     ...
     * @return the ExpressRouteCrossConnectionRoutesTableSummary object itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummary setUpDown(String upDown) {
        this.upDown = upDown;
        return this;
    }
     ...
     * @return the ExpressRouteCrossConnectionRoutesTableSummary object itself.
     */
    public ExpressRouteCrossConnectionRoutesTableSummary setStateOrPrefixesReceived(String stateOrPrefixesReceived) {
