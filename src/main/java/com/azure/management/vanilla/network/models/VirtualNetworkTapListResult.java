...
public final class VirtualNetworkTapListResult {
    ...
    private List<VirtualNetworkTap> value;
     ...
     */
    public List<VirtualNetworkTap> getValue() {
        return this.value;
    }
     ...
     */
    public VirtualNetworkTapListResult setValue(List<VirtualNetworkTap> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the VirtualNetworkTapListResult object itself.
     */
    public VirtualNetworkTapListResult setNextLink(String nextLink) {
