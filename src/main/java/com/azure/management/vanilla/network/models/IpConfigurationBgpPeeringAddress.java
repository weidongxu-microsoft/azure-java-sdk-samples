...
public final class IpConfigurationBgpPeeringAddress {
     ...
     */
    public String getIpconfigurationId() {
     ...
     */
    public IpConfigurationBgpPeeringAddress setIpconfigurationId(String ipconfigurationId) {
     ...
     * @return the IpConfigurationBgpPeeringAddress object itself.
     */
    public IpConfigurationBgpPeeringAddress setCustomBgpIpAddresses(List<String> customBgpIpAddresses) {
