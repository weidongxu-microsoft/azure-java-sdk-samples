...
public class ContainerNetworkInterface extends SubResource {
     ...
     */
    public SubResource getContainer() {
     ...
     * @return the ContainerNetworkInterface object itself.
     */
    public ContainerNetworkInterface setContainer(SubResource container) {
    ...
    public void validate() {
        if (getContainerNetworkInterfaceConfiguration() != null) {
            getContainerNetworkInterfaceConfiguration().validate();
        }
