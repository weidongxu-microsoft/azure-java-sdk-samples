...
public final class ApplicationGatewayBackendHealthServer {
    ...
    private NetworkInterfaceIpConfiguration ipConfiguration;
     ...
     */
    public ApplicationGatewayBackendHealthServer setAddress(String address) {
     ...
     */
    public NetworkInterfaceIpConfiguration getIpConfiguration() {
     ...
     * @return the ApplicationGatewayBackendHealthServer object itself.
     */
    public ApplicationGatewayBackendHealthServer setIpConfiguration(NetworkInterfaceIpConfiguration ipConfiguration) {
     ...
     * @return the ApplicationGatewayBackendHealthServer object itself.
     */
    public ApplicationGatewayBackendHealthServer setHealth(ApplicationGatewayBackendHealthServerHealth health) {
        this.health = health;
        return this;
    }
     ...
     * @return the ApplicationGatewayBackendHealthServer object itself.
     */
    public ApplicationGatewayBackendHealthServer setHealthProbeLog(String healthProbeLog) {
