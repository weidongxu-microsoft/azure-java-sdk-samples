...
/** The VpnSiteLinkConnection model. */
@JsonFlatten
@Fluent
public class VpnSiteLinkConnection extends SubResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VpnSiteLinkConnection.class);
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setName(String name) {
        this.name = name;
        return this;
    }
     ...
     */
    public SubResource getVpnSiteLink() {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setVpnSiteLink(SubResource vpnSiteLink) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setRoutingWeight(Integer routingWeight) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setVpnConnectionProtocolType(
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setConnectionBandwidth(Integer connectionBandwidth) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setSharedKey(String sharedKey) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setEnableBgp(Boolean enableBgp) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setUsePolicyBasedTrafficSelectors(Boolean usePolicyBasedTrafficSelectors) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setIpsecPolicies(List<IpsecPolicy> ipsecPolicies) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setEnableRateLimiting(Boolean enableRateLimiting) {
     ...
     * @return the VpnSiteLinkConnection object itself.
     */
    public VpnSiteLinkConnection setUseLocalAzureIpAddress(Boolean useLocalAzureIpAddress) {
