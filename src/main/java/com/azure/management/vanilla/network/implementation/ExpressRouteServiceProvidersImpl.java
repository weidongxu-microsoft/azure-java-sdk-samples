...
import com.azure.management.vanilla.network.models.ExpressRouteServiceProviderListResult;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in ExpressRouteServiceProviders. */
public final class ExpressRouteServiceProvidersImpl {
    private final ClientLogger logger = new ClientLogger(ExpressRouteServiceProvidersImpl.class);
    ...
    /**
     * Initializes an instance of ExpressRouteServiceProvidersImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ExpressRouteServiceProvidersImpl(NetworkManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    public Mono<PagedResponse<ExpressRouteServiceProvider>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ExpressRouteServiceProvider>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteServiceProvider>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<ExpressRouteServiceProvider> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ExpressRouteServiceProvider> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteServiceProvider>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ExpressRouteServiceProvider>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
