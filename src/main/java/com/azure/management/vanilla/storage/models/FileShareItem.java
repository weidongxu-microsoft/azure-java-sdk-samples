...
@JsonFlatten
@Fluent
public class FileShareItem extends AzureEntityResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(FileShareItem.class);
     ...
     * @return the FileShareItem object itself.
     */
    public FileShareItem setMetadata(Map<String, String> metadata) {
     ...
     * @return the FileShareItem object itself.
     */
    public FileShareItem setShareQuota(Integer shareQuota) {
     ...
     * @return the FileShareItem object itself.
     */
    public FileShareItem setEnabledProtocols(EnabledProtocols enabledProtocols) {
     ...
     */
    public RootSquashType getRootSquash() {
     ...
     * @return the FileShareItem object itself.
     */
    public FileShareItem setRootSquash(RootSquashType rootSquash) {
     ...
     * @return the FileShareItem object itself.
     */
    public FileShareItem setAccessTier(ShareAccessTier accessTier) {
