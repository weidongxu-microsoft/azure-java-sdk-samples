...
public final class LegalHold {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LegalHold.class);
     ...
     */
    public LegalHold setTags(List<String> tags) {
        this.tags = tags;
        return this;
    }
    ...
    public void validate() {
        if (getTags() == null) {
            throw logger
                .logExceptionAsError(new IllegalArgumentException("Missing required property tags in model LegalHold"));
        }
    }
}
