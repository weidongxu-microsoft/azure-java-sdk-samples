...
import com.azure.management.vanilla.storage.models.StorageSkuListResult;
...
public final class SkusImpl {
    ...
    public Mono<PagedResponse<SkuInformation>> listSinglePageAsync() {
                ...
                context ->
                    service
                        .list(
                            ...
                            context))
            .<PagedResponse<SkuInformation>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<SkuInformation>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<SkuInformation> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<SkuInformation> listAsync(Context context) {
