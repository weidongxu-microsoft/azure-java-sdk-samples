...
import com.azure.management.vanilla.storage.models.PrivateEndpointConnectionListResult;
...
public final class PrivateEndpointConnectionsImpl {
    ...
    private interface PrivateEndpointConnectionsService {
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<PrivateEndpointConnection>> put(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<PagedResponse<PrivateEndpointConnection>> listSinglePageAsync(
    ...
    public PagedFlux<PrivateEndpointConnection> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<PrivateEndpointConnection> listAsync(
        String resourceGroupName, String accountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<PrivateEndpointConnection>> putWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateEndpointConnection> putAsync(
        String resourceGroupName,
        String accountName,
        String privateEndpointConnectionName,
        PrivateEndpointConnection properties) {
