...
@Fluent
public final class LeaseContainerResponse {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(LeaseContainerResponse.class);
     ...
     * @return the LeaseContainerResponse object itself.
     */
    public LeaseContainerResponse setLeaseId(String leaseId) {
     ...
     * @return the LeaseContainerResponse object itself.
     */
    public LeaseContainerResponse setLeaseTimeSeconds(String leaseTimeSeconds) {
