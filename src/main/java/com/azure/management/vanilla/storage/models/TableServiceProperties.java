...
@JsonFlatten
@Fluent
public class TableServiceProperties extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(TableServiceProperties.class);
     ...
     */
    public TableServiceProperties setCors(CorsRules cors) {
        this.cors = cors;
        return this;
    }
