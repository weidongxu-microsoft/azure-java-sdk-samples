...
@JsonFlatten
@Fluent
public class BlobContainer extends AzureEntityResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(BlobContainer.class);
     ...
     */
    public BlobContainer setDefaultEncryptionScope(String defaultEncryptionScope) {
     ...
     * @return the BlobContainer object itself.
     */
    public BlobContainer setDenyEncryptionScopeOverride(Boolean denyEncryptionScopeOverride) {
     ...
     * @return the BlobContainer object itself.
     */
    public BlobContainer setPublicAccess(PublicAccess publicAccess) {
     ...
     * @return the BlobContainer object itself.
     */
    public BlobContainer setMetadata(Map<String, String> metadata) {
