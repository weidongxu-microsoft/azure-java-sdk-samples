...
public final class ManagementPoliciesImpl implements InnerSupportsDelete<Void> {
    ...
    private interface ManagementPoliciesService {
        ...
        Mono<Response<ManagementPolicy>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ManagementPolicy>> createOrUpdate(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("managementPolicyName") String managementPolicyName,
            @BodyParam("application/json") ManagementPolicy properties,
            Context context);
    ...
    public Mono<Response<ManagementPolicy>> getWithResponseAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ManagementPolicy>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ManagementPolicy> getAsync(String resourceGroupName, String accountName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ManagementPolicy>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ManagementPolicy> createOrUpdateAsync(
        String resourceGroupName, String accountName, ManagementPolicySchema policy) {
