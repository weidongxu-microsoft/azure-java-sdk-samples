...
import com.azure.management.vanilla.storage.models.ListQueueResource;
...
public final class QueuesImpl {
    ...
    private interface QueuesService {
        ...
        Mono<Response<StorageQueue>> create(
            ...
            @BodyParam("application/json") StorageQueue queue,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageQueue>> update(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageQueue>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<StorageQueue>> createWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageQueue>> updateWithResponseAsync(
        String resourceGroupName, String accountName, String queueName, Map<String, String> metadata) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageQueue> updateAsync(
        String resourceGroupName, String accountName, String queueName, Map<String, String> metadata) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageQueue>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageQueue> getAsync(String resourceGroupName, String accountName, String queueName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageQueue> getAsync(
        String resourceGroupName, String accountName, String queueName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ListQueue>> listSinglePageAsync(
    ...
    public PagedFlux<ListQueue> listAsync(
        String resourceGroupName, String accountName, String maxpagesize, String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ListQueue> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ListQueue>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ListQueue>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
