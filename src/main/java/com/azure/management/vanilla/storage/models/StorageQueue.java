...
@JsonFlatten
@Fluent
public class StorageQueue extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(StorageQueue.class);
     ...
     * @return the StorageQueue object itself.
     */
    public StorageQueue setMetadata(Map<String, String> metadata) {
