...
@JsonFlatten
@Fluent
public class ImmutabilityPolicy extends AzureEntityResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ImmutabilityPolicy.class);
     ...
     * @return the ImmutabilityPolicy object itself.
     */
    public ImmutabilityPolicy setImmutabilityPeriodSinceCreationInDays(Integer immutabilityPeriodSinceCreationInDays) {
     ...
     * @return the ImmutabilityPolicy object itself.
     */
    public ImmutabilityPolicy setAllowProtectedAppendWrites(Boolean allowProtectedAppendWrites) {
