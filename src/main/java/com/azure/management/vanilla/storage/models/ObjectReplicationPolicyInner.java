...
public class ObjectReplicationPolicyInner extends ProxyResource {
     ...
     */
    public ObjectReplicationPolicyInner setSourceAccount(String sourceAccount) {
     ...
     * @return the ObjectReplicationPolicyInner object itself.
     */
    public ObjectReplicationPolicyInner setDestinationAccount(String destinationAccount) {
