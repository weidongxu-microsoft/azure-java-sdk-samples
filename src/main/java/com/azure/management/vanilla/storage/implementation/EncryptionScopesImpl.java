...
import com.azure.management.vanilla.storage.models.EncryptionScopeListResult;
...
public final class EncryptionScopesImpl {
    ...
    private interface EncryptionScopesService {
        ...
        Mono<Response<EncryptionScope>> put(
            ...
            @BodyParam("application/json") EncryptionScope encryptionScope,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EncryptionScope>> patch(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<EncryptionScope>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<EncryptionScope>> putWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<EncryptionScope>> patchWithResponseAsync(
        String resourceGroupName, String accountName, String encryptionScopeName, EncryptionScope encryptionScope) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<EncryptionScope> patchAsync(
        String resourceGroupName, String accountName, String encryptionScopeName, EncryptionScope encryptionScope) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<EncryptionScope>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<EncryptionScope> getAsync(String resourceGroupName, String accountName, String encryptionScopeName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<EncryptionScope> getAsync(
        String resourceGroupName, String accountName, String encryptionScopeName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EncryptionScope>> listSinglePageAsync(String resourceGroupName, String accountName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<EncryptionScope>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EncryptionScope>> listSinglePageAsync(
    ...
    public PagedFlux<EncryptionScope> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<EncryptionScope> listAsync(String resourceGroupName, String accountName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EncryptionScope>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<EncryptionScope>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
