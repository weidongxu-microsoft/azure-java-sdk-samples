...
@JsonFlatten
@Fluent
public class ManagementPolicy extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(ManagementPolicy.class);
     ...
     * @return the ManagementPolicy object itself.
     */
    public ManagementPolicy setPolicy(ManagementPolicySchema policy) {
        this.policy = policy;
        return this;
    }
