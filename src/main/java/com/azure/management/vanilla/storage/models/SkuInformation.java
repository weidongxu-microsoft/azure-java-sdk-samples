...
public final class SkuInformation {
     ...
     */
    public SkuInformation setName(SkuName name) {
        this.name = name;
        return this;
    }
     ...
     * @return the SkuInformation object itself.
     */
    public SkuInformation setRestrictions(List<Restriction> restrictions) {
    ...
    public void validate() {
        if (getName() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property name in model SkuInformation"));
        }
        if (getCapabilities() != null) {
            getCapabilities().forEach(e -> e.validate());
        }
        if (getRestrictions() != null) {
            getRestrictions().forEach(e -> e.validate());
        }
    }
}
