...
public final class PrivateLinkResourcesImpl {
    ...
    private interface PrivateLinkResourcesService {
        ...
        Mono<Response<PrivateLinkResourceListResult>> listByStorageAccount(
    ...
    public Mono<Response<PrivateLinkResourceListResult>> listByStorageAccountWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateLinkResourceListResult> listByStorageAccountAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PrivateLinkResourceListResult> listByStorageAccountAsync(
        String resourceGroupName, String accountName, Context context) {
