...
import com.azure.management.vanilla.storage.models.UsageListResult;
...
public final class UsagesImpl {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Usage>> listByLocationSinglePageAsync(String location, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Usage> listByLocationAsync(String location, Context context) {
