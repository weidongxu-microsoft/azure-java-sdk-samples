...
public class ListContainerItemInner extends AzureEntityResource {
     ...
     */
    public ListContainerItemInner setDefaultEncryptionScope(String defaultEncryptionScope) {
     ...
     * @return the ListContainerItemInner object itself.
     */
    public ListContainerItemInner setDenyEncryptionScopeOverride(Boolean denyEncryptionScopeOverride) {
