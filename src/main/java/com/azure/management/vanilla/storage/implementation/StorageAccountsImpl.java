...
import com.azure.management.vanilla.storage.models.StorageAccountCheckNameAvailabilityParameters;
...
import com.azure.management.vanilla.storage.models.StorageAccountListResult;
import com.azure.management.vanilla.storage.models.StorageAccountRegenerateKeyParameters;
...
public final class StorageAccountsImpl
    implements InnerSupportsGet<StorageAccount>, InnerSupportsListing<StorageAccount>, InnerSupportsDelete<Void> {
    ...
    private interface StorageAccountsService {
        ...
        Mono<Response<CheckNameAvailabilityResult>> checkNameAvailability(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageAccount>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageAccount>> update(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageAccountListKeysResult>> listKeys(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageAccountListKeysResult>> regenerateKey(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListAccountSasResponse>> listAccountSas(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ListServiceSasResponse>> listServiceSas(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<StorageAccount>> beginCreateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<BlobRestoreStatus>> beginRestoreBlobRangesWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<Response<CheckNameAvailabilityResult>> checkNameAvailabilityWithResponseAsync(String name) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<CheckNameAvailabilityResult>> checkNameAvailabilityWithResponseAsync(
    ...
    public Mono<CheckNameAvailabilityResult> checkNameAvailabilityAsync(String name) {
        return checkNameAvailabilityWithResponseAsync(name)
            .flatMap(
                (Response<CheckNameAvailabilityResult> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<CheckNameAvailabilityResult> checkNameAvailabilityAsync(String name, Context context) {
    ...
    public PollerFlux<PollResult<StorageAccount>, StorageAccount> beginCreate(
        ...
        return this
            .client
            .<StorageAccount, StorageAccount>getLroResultAsync(
                mono, this.client.getHttpPipeline(), StorageAccount.class, StorageAccount.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccount> createAsync(
        String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = createWithResponseAsync(resourceGroupName, accountName, parameters);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageAccount>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccount> getByResourceGroupAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageAccount>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccount> updateAsync(
        String resourceGroupName, String accountName, StorageAccountUpdateParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<StorageAccount>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<StorageAccount> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<StorageAccount> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<StorageAccount> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<StorageAccount> listByResourceGroupAsync(String resourceGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageAccountListKeysResult>> listKeysWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccountListKeysResult> listKeysAsync(
        String resourceGroupName, String accountName, ListKeyExpand expand) {
        return listKeysWithResponseAsync(resourceGroupName, accountName, expand)
            .flatMap(
                (Response<StorageAccountListKeysResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccountListKeysResult> listKeysAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageAccountListKeysResult>> regenerateKeyWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccountListKeysResult> regenerateKeyAsync(
        String resourceGroupName, String accountName, String keyName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ListAccountSasResponse>> listAccountSasWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ListAccountSasResponse> listAccountSasAsync(
        String resourceGroupName, String accountName, AccountSasParameters parameters) {
        return listAccountSasWithResponseAsync(resourceGroupName, accountName, parameters)
            .flatMap(
                (Response<ListAccountSasResponse> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ListServiceSasResponse>> listServiceSasWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ListServiceSasResponse> listServiceSasAsync(
        String resourceGroupName, String accountName, ServiceSasParameters parameters) {
        return listServiceSasWithResponseAsync(resourceGroupName, accountName, parameters)
            .flatMap(
                (Response<ListServiceSasResponse> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public PollerFlux<PollResult<BlobRestoreStatus>, BlobRestoreStatus> beginRestoreBlobRanges(
        ...
        return this
            .client
            .<BlobRestoreStatus, BlobRestoreStatus>getLroResultAsync(
                mono, this.client.getHttpPipeline(), BlobRestoreStatus.class, BlobRestoreStatus.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BlobRestoreStatus> restoreBlobRangesAsync(
        String resourceGroupName, String accountName, BlobRestoreParameters parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            restoreBlobRangesWithResponseAsync(resourceGroupName, accountName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<StorageAccount>> beginCreateWithoutPollingWithResponseAsync(
        String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<StorageAccount> beginCreateWithoutPollingAsync(
        String resourceGroupName, String accountName, StorageAccountCreateParameters parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<BlobRestoreStatus>> beginRestoreBlobRangesWithoutPollingWithResponseAsync(
        String resourceGroupName, String accountName, BlobRestoreParameters parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<BlobRestoreStatus> beginRestoreBlobRangesWithoutPollingAsync(
        String resourceGroupName, String accountName, BlobRestoreParameters parameters) {
        return beginRestoreBlobRangesWithoutPollingWithResponseAsync(resourceGroupName, accountName, parameters)
            .flatMap(
                (Response<BlobRestoreStatus> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public Mono<BlobRestoreStatus> beginRestoreBlobRangesWithoutPollingAsync(
        ...
        return beginRestoreBlobRangesWithoutPollingWithResponseAsync(
                resourceGroupName, accountName, parameters, context)
            .flatMap(
                (Response<BlobRestoreStatus> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public BlobRestoreStatus beginRestoreBlobRangesWithoutPolling(
        String resourceGroupName, String accountName, BlobRestoreParameters parameters) {
        return beginRestoreBlobRangesWithoutPollingAsync(resourceGroupName, accountName, parameters).block();
    }
    ...
    public BlobRestoreStatus beginRestoreBlobRangesWithoutPolling(
        String resourceGroupName, String accountName, BlobRestoreParameters parameters, Context context) {
        return beginRestoreBlobRangesWithoutPollingAsync(resourceGroupName, accountName, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<StorageAccount>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
