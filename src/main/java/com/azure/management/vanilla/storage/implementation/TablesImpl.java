...
import com.azure.management.vanilla.storage.models.ListTableResource;
...
public final class TablesImpl {
    ...
    public Mono<Response<Table>> createWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> createAsync(String resourceGroupName, String accountName, String tableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> createAsync(String resourceGroupName, String accountName, String tableName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Table>> updateWithResponseAsync(
        String resourceGroupName, String accountName, String tableName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> updateAsync(String resourceGroupName, String accountName, String tableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> updateAsync(String resourceGroupName, String accountName, String tableName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Table>> getWithResponseAsync(String resourceGroupName, String accountName, String tableName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Table>> getWithResponseAsync(
        String resourceGroupName, String accountName, String tableName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> getAsync(String resourceGroupName, String accountName, String tableName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Table> getAsync(String resourceGroupName, String accountName, String tableName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Table>> listSinglePageAsync(String resourceGroupName, String accountName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Table>> listSinglePageAsync(
    ...
    public PagedFlux<Table> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Table> listAsync(String resourceGroupName, String accountName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Table>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Table>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
