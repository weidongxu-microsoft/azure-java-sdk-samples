...
@JsonFlatten
@Fluent
public class FileServiceProperties extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(FileServiceProperties.class);
     ...
     */
    public FileServiceProperties setCors(CorsRules cors) {
        this.cors = cors;
        return this;
    }
     ...
     * @return the FileServiceProperties object itself.
     */
    public FileServiceProperties setShareDeleteRetentionPolicy(DeleteRetentionPolicy shareDeleteRetentionPolicy) {
