...
@JsonFlatten
@Fluent
public class EncryptionScope extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(EncryptionScope.class);
     ...
     */
    public EncryptionScope setSource(EncryptionScopeSource source) {
        this.source = source;
        return this;
    }
     ...
     * @return the EncryptionScope object itself.
     */
    public EncryptionScope setState(EncryptionScopeState state) {
        this.state = state;
        return this;
    }
     ...
     * @return the EncryptionScope object itself.
     */
    public EncryptionScope setKeyVaultProperties(EncryptionScopeKeyVaultProperties keyVaultProperties) {
