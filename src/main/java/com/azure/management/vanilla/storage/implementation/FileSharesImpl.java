...
import com.azure.management.vanilla.storage.models.FileShareItems;
...
public final class FileSharesImpl {
    ...
    private interface FileSharesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FileShare>> create(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") FileShare fileShare,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<FileShare>> update(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("accountName") String accountName,
            @PathParam("shareName") String shareName,
    ...
    public Mono<PagedResponse<FileShareItem>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            expand,
                            context))
            .<PagedResponse<FileShareItem>>map(
                res ->
    ...
    public PagedFlux<FileShareItem> listAsync(
        String resourceGroupName, String accountName, String maxpagesize, String filter, ListSharesExpand expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<FileShareItem> listAsync(String resourceGroupName, String accountName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FileShare>> createWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FileShare>> updateWithResponseAsync(
        String resourceGroupName, String accountName, String shareName, FileShare fileShare) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FileShare> updateAsync(
        String resourceGroupName, String accountName, String shareName, FileShare fileShare) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<FileShare>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FileShare> getAsync(
        String resourceGroupName, String accountName, String shareName, GetShareExpand expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<FileShare> getAsync(String resourceGroupName, String accountName, String shareName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FileShareItem>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<FileShareItem>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
