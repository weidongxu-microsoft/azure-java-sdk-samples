...
@JsonFlatten
@Fluent
public class FileShare extends AzureEntityResource {
     ...
     */
    public FileShare setMetadata(Map<String, String> metadata) {
     ...
     * @return the FileShare object itself.
     */
    public FileShare setShareQuota(Integer shareQuota) {
     ...
     * @return the FileShare object itself.
     */
    public FileShare setEnabledProtocols(EnabledProtocols enabledProtocols) {
     ...
     * @return the FileShare object itself.
     */
    public FileShare setRootSquash(RootSquashType rootSquash) {
     ...
     * @return the FileShare object itself.
     */
    public FileShare setAccessTier(ShareAccessTier accessTier) {
