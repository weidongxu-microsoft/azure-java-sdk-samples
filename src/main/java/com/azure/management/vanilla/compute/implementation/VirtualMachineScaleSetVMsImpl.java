...
import com.azure.management.vanilla.compute.models.VirtualMachineScaleSetVMListResult;
...
public final class VirtualMachineScaleSetVMsImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineScaleSetVMsImpl.class);
    ...
    private interface VirtualMachineScaleSetVMsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> update(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") VirtualMachineScaleSetVM parameters,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetVM>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetVMInstanceView>> getInstanceView(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetVM>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
    ...
    public Mono<Response<Flux<ByteBuffer>>> reimageWithResponseAsync(
        ...
        if (tempDisk != null) {
            ...
            vmScaleSetVMReimageInputInternal.setTempDisk(tempDisk);
        }
    ...
    public PollerFlux<PollResult<VirtualMachineScaleSetVM>, VirtualMachineScaleSetVM> beginUpdate(
        ...
        return this
            .client
            .<VirtualMachineScaleSetVM, VirtualMachineScaleSetVM>getLroResultAsync(
                mono, this.client.getHttpPipeline(), VirtualMachineScaleSetVM.class, VirtualMachineScaleSetVM.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetVM> updateAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, VirtualMachineScaleSetVM parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetVM>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetVM> getAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, InstanceViewTypes expand) {
        return getWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, expand)
            .flatMap(
                (Response<VirtualMachineScaleSetVM> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetVM> getAsync(String resourceGroupName, String vmScaleSetName, String instanceId) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetVMInstanceView>> getInstanceViewWithResponseAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetVMInstanceView> getInstanceViewAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId) {
        return getInstanceViewWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId)
            .flatMap(
                (Response<VirtualMachineScaleSetVMInstanceView> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetVM>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<VirtualMachineScaleSetVM>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualMachineScaleSetVM> listAsync(String resourceGroupName, String virtualMachineScaleSetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetVM>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, VirtualMachineScaleSetVM parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetVM> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, VirtualMachineScaleSetVM parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetVM>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetVM>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
