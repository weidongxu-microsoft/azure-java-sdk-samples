...
/** The VirtualMachineScaleSetUpdateNetworkProfile model. */
@Fluent
public final class VirtualMachineScaleSetUpdateNetworkProfile {
     ...
     */
    public ApiEntityReference getHealthProbe() {
     ...
     */
    public VirtualMachineScaleSetUpdateNetworkProfile setHealthProbe(ApiEntityReference healthProbe) {
     ...
     */
    public List<VirtualMachineScaleSetUpdateNetworkConfiguration> getNetworkInterfaceConfigurations() {
     ...
     * @return the VirtualMachineScaleSetUpdateNetworkProfile object itself.
     */
    public VirtualMachineScaleSetUpdateNetworkProfile setNetworkInterfaceConfigurations(
    ...
    public void validate() {
        if (getHealthProbe() != null) {
            getHealthProbe().validate();
        }
