...
@JsonFlatten
@Fluent
public class GalleryApplicationVersion extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(GalleryApplicationVersion.class);
     ...
     * @return the GalleryApplicationVersion object itself.
     */
    public GalleryApplicationVersion setPublishingProfile(
     ...
     */
    public GalleryApplicationVersionPropertiesProvisioningState getProvisioningState() {
