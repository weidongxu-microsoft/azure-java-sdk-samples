...
/** The GalleryImage model. */
@JsonFlatten
@Fluent
public class GalleryImage extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(GalleryImage.class);
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setDescription(String description) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setEula(String eula) {
        this.eula = eula;
        return this;
    }
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setPrivacyStatementUri(String privacyStatementUri) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setReleaseNoteUri(String releaseNoteUri) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setOsType(OperatingSystemTypes osType) {
        this.osType = osType;
        return this;
    }
     ...
     */
    public OperatingSystemStateTypes getOsState() {
        return this.osState;
    }
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setOsState(OperatingSystemStateTypes osState) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setHyperVGeneration(HyperVGeneration hyperVGeneration) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setEndOfLifeDate(OffsetDateTime endOfLifeDate) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setIdentifier(GalleryImageIdentifier identifier) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setRecommended(RecommendedMachineConfiguration recommended) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setDisallowed(Disallowed disallowed) {
     ...
     * @return the GalleryImage object itself.
     */
    public GalleryImage setPurchasePlan(ImagePurchasePlan purchasePlan) {
     ...
     */
    public GalleryImagePropertiesProvisioningState getProvisioningState() {
    ...
    public void validate() {
        ...
        if (getRecommended() != null) {
            getRecommended().validate();
        }
        if (getDisallowed() != null) {
            getDisallowed().validate();
        }
        if (getPurchasePlan() != null) {
            getPurchasePlan().validate();
        }
    }
}
