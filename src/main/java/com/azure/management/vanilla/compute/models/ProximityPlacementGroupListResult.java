...
public final class ProximityPlacementGroupListResult {
    ...
    private List<ProximityPlacementGroup> value;
     ...
     */
    public List<ProximityPlacementGroup> getValue() {
        return this.value;
    }
     ...
     */
    public ProximityPlacementGroupListResult setValue(List<ProximityPlacementGroup> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the ProximityPlacementGroupListResult object itself.
     */
    public ProximityPlacementGroupListResult setNextLink(String nextLink) {
