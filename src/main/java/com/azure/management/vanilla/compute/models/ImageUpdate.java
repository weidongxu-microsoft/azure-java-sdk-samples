...
public class ImageUpdate extends UpdateResource {
     ...
     */
    public ImageUpdate setSourceVirtualMachine(SubResource sourceVirtualMachine) {
     ...
     * @return the ImageUpdate object itself.
     */
    public ImageUpdate setStorageProfile(ImageStorageProfile storageProfile) {
     ...
     * @return the ImageUpdate object itself.
     */
    public ImageUpdate setHyperVGeneration(HyperVGenerationTypes hyperVGeneration) {
