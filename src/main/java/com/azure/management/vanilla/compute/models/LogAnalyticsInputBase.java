...
public class LogAnalyticsInputBase {
     ...
     */
    public LogAnalyticsInputBase setBlobContainerSasUri(String blobContainerSasUri) {
     ...
     * @return the LogAnalyticsInputBase object itself.
     */
    public LogAnalyticsInputBase setFromTime(OffsetDateTime fromTime) {
     ...
     * @return the LogAnalyticsInputBase object itself.
     */
    public LogAnalyticsInputBase setToTime(OffsetDateTime toTime) {
        this.toTime = toTime;
        return this;
    }
     ...
     */
    public Boolean isGroupByThrottlePolicy() {
     ...
     * @return the LogAnalyticsInputBase object itself.
     */
    public LogAnalyticsInputBase setGroupByThrottlePolicy(Boolean groupByThrottlePolicy) {
     ...
     */
    public Boolean isGroupByOperationName() {
     ...
     * @return the LogAnalyticsInputBase object itself.
     */
    public LogAnalyticsInputBase setGroupByOperationName(Boolean groupByOperationName) {
     ...
     */
    public Boolean isGroupByResourceName() {
     ...
     * @return the LogAnalyticsInputBase object itself.
     */
    public LogAnalyticsInputBase setGroupByResourceName(Boolean groupByResourceName) {
    ...
    public void validate() {
        if (getBlobContainerSasUri() == null) {
            throw logger
                .logExceptionAsError(
