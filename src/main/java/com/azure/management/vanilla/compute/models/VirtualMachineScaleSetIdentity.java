...
public final class VirtualMachineScaleSetIdentity {
     ...
     */
    public VirtualMachineScaleSetIdentity setType(ResourceIdentityType type) {
        this.type = type;
        return this;
    }
     ...
     */
    public Map<String, VirtualMachineScaleSetIdentityUserAssignedIdentities> getUserAssignedIdentities() {
     ...
     * @return the VirtualMachineScaleSetIdentity object itself.
     */
    public VirtualMachineScaleSetIdentity setUserAssignedIdentities(
    ...
    public void validate() {
        if (getUserAssignedIdentities() != null) {
