...
import com.azure.management.vanilla.compute.models.ComputeOperationListResult;
...
public final class OperationsImpl {
    ...
    public Mono<PagedResponse<ComputeOperationValue>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ComputeOperationValue>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ComputeOperationValue>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<ComputeOperationValue> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ComputeOperationValue> listAsync(Context context) {
