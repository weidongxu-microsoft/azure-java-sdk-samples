...
public final class VirtualMachineExtensionImagesImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineExtensionImagesImpl.class);
    ...
    private interface VirtualMachineExtensionImagesService {
        ...
        Mono<Response<VirtualMachineExtensionImage>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineExtensionImage>>> listTypes(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @PathParam("publisherName") String publisherName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineExtensionImage>>> listVersions(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @PathParam("publisherName") String publisherName,
            @PathParam("type") String type,
    ...
    public Mono<Response<VirtualMachineExtensionImage>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtensionImage> getAsync(
        String location, String publisherName, String type, String version) {
        return getWithResponseAsync(location, publisherName, type, version)
            .flatMap(
                (Response<VirtualMachineExtensionImage> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineExtensionImage>>> listTypesWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineExtensionImage>> listTypesAsync(String location, String publisherName) {
        return listTypesWithResponseAsync(location, publisherName)
            .flatMap(
                (Response<List<VirtualMachineExtensionImage>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineExtensionImage>> listTypesAsync(
        String location, String publisherName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineExtensionImage>>> listVersionsWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineExtensionImage>> listVersionsAsync(
        String location, String publisherName, String type, String filter, Integer top, String orderby) {
