...
@Fluent
public final class VirtualMachineScaleSetVMInstanceView {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VirtualMachineScaleSetVMInstanceView.class);
     ...
     */
    public VirtualMachineScaleSetVMInstanceView setPlatformUpdateDomain(Integer platformUpdateDomain) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setPlatformFaultDomain(Integer platformFaultDomain) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setRdpThumbPrint(String rdpThumbPrint) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setVmAgent(VirtualMachineAgentInstanceView vmAgent) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setMaintenanceRedeployStatus(
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setDisks(List<DiskInstanceView> disks) {
        this.disks = disks;
        return this;
    }
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setExtensions(List<VirtualMachineExtensionInstanceView> extensions) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setBootDiagnostics(BootDiagnosticsInstanceView bootDiagnostics) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setStatuses(List<InstanceViewStatus> statuses) {
     ...
     * @return the VirtualMachineScaleSetVMInstanceView object itself.
     */
    public VirtualMachineScaleSetVMInstanceView setPlacementGroupId(String placementGroupId) {
    ...
    public void validate() {
        ...
        if (getMaintenanceRedeployStatus() != null) {
            getMaintenanceRedeployStatus().validate();
        }
        if (getDisks() != null) {
            getDisks().forEach(e -> e.validate());
        }
        if (getExtensions() != null) {
            getExtensions().forEach(e -> e.validate());
        }
        if (getVmHealth() != null) {
            getVmHealth().validate();
        }
