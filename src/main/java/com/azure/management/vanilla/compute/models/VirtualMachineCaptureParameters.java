...
public final class VirtualMachineCaptureParameters {
     ...
     */
    public VirtualMachineCaptureParameters setVhdPrefix(String vhdPrefix) {
     ...
     * @return the VirtualMachineCaptureParameters object itself.
     */
    public VirtualMachineCaptureParameters setDestinationContainerName(String destinationContainerName) {
     ...
     */
    public boolean isOverwriteVhds() {
     ...
     * @return the VirtualMachineCaptureParameters object itself.
     */
    public VirtualMachineCaptureParameters setOverwriteVhds(boolean overwriteVhds) {
