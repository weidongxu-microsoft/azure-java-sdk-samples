...
public final class ImageStorageProfile {
     ...
     */
    public ImageStorageProfile setOsDisk(ImageOSDisk osDisk) {
        this.osDisk = osDisk;
        return this;
    }
     ...
     * @return the ImageStorageProfile object itself.
     */
    public ImageStorageProfile setDataDisks(List<ImageDataDisk> dataDisks) {
     ...
     * @return the ImageStorageProfile object itself.
     */
    public ImageStorageProfile setZoneResilient(Boolean zoneResilient) {
