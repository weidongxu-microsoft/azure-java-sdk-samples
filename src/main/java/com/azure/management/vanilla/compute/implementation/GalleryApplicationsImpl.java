...
import com.azure.management.vanilla.compute.models.GalleryApplicationList;
...
public final class GalleryApplicationsImpl {
    private final ClientLogger logger = new ClientLogger(GalleryApplicationsImpl.class);
    ...
    /**
     * Initializes an instance of GalleryApplicationsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    GalleryApplicationsImpl(ComputeManagementClientImpl client) {
        this.service =
    ...
    private interface GalleryApplicationsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") GalleryApplication galleryApplication,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplication>> get(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplication>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplication>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
    ...
    public PollerFlux<PollResult<GalleryApplication>, GalleryApplication> beginCreateOrUpdate(
        ...
        return this
            .client
            .<GalleryApplication, GalleryApplication>getLroResultAsync(
                mono, this.client.getHttpPipeline(), GalleryApplication.class, GalleryApplication.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplication> createOrUpdateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplication galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplication> updateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplicationUpdate galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplication>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplication>> listByGallerySinglePageAsync(
                ...
                context ->
                    service
                        .listByGallery(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<GalleryApplication>>map(
                res ->
    ...
    public PagedFlux<GalleryApplication> listByGalleryAsync(String resourceGroupName, String galleryName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GalleryApplication> listByGalleryAsync(
        String resourceGroupName, String galleryName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplication>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplication galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplication> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplication galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplication>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplicationUpdate galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplication> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        GalleryApplicationUpdate galleryApplication) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplication>> listByGalleryNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplication>> listByGalleryNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
