...
import com.azure.management.vanilla.compute.models.GalleryApplicationVersionList;
...
public final class GalleryApplicationVersionsImpl {
    private final ClientLogger logger = new ClientLogger(GalleryApplicationVersionsImpl.class);
    ...
    /**
     * Initializes an instance of GalleryApplicationVersionsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    GalleryApplicationVersionsImpl(ComputeManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface GalleryApplicationVersionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") GalleryApplicationVersion galleryApplicationVersion,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplicationVersion>> get(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplicationVersion>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryApplicationVersion>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
    ...
    public PollerFlux<PollResult<GalleryApplicationVersion>, GalleryApplicationVersion> beginCreateOrUpdate(
        ...
        return this
            .client
            .<GalleryApplicationVersion, GalleryApplicationVersion>getLroResultAsync(
                mono, this.client.getHttpPipeline(), GalleryApplicationVersion.class, GalleryApplicationVersion.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplicationVersion> createOrUpdateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplicationVersion> updateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplicationVersion>> getWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplicationVersion> getAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
        ...
        return getWithResponseAsync(
            ...
            .flatMap(
                (Response<GalleryApplicationVersion> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplicationVersion>> listByGalleryApplicationSinglePageAsync(
                ...
                context ->
                    service
                        .listByGalleryApplication(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<GalleryApplicationVersion>>map(
                res ->
    ...
    public PagedFlux<GalleryApplicationVersion> listByGalleryApplicationAsync(
        String resourceGroupName, String galleryName, String galleryApplicationName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplicationVersion>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplicationVersion> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryApplicationVersion>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryApplicationVersion> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryApplicationName,
        String galleryApplicationVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplicationVersion>> listByGalleryApplicationNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryApplicationVersion>> listByGalleryApplicationNextSinglePageAsync(
