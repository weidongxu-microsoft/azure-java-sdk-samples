...
import com.azure.management.vanilla.compute.models.ImageListResult;
...
public final class ImagesImpl
    implements InnerSupportsGet<Image>, InnerSupportsListing<Image>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(ImagesImpl.class);
    ...
    private interface ImagesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") Image parameters,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Image>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("imageName") String imageName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Image>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("imageName") String imageName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Image>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("imageName") String imageName,
            @QueryParam("api-version") String apiVersion,
    ...
    public PollerFlux<PollResult<Image>, Image> beginCreateOrUpdate(
        ...
        return this
            .client
            .<Image, Image>getLroResultAsync(mono, this.client.getHttpPipeline(), Image.class, Image.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> createOrUpdateAsync(String resourceGroupName, String imageName, Image parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, imageName, parameters);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> createOrUpdateAsync(
        String resourceGroupName, String imageName, Image parameters, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, imageName, parameters, context);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> updateAsync(String resourceGroupName, String imageName, ImageUpdate parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, imageName, parameters);
        return this
            .client
            .<Image, Image>getLroResultAsync(mono, this.client.getHttpPipeline(), Image.class, Image.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Image>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> getByResourceGroupAsync(String resourceGroupName, String imageName, String expand) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> getByResourceGroupAsync(
        String resourceGroupName, String imageName, String expand, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, imageName, expand, context)
            .flatMap(
                (Response<Image> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> getByResourceGroupAsync(String resourceGroupName, String imageName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listByResourceGroupSinglePageAsync(String resourceGroupName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<Image> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Image> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Image> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Image> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Image>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String imageName, Image parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String imageName, Image parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Image>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String imageName, ImageUpdate parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Image> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String imageName, ImageUpdate parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listByResourceGroupNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Image>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
