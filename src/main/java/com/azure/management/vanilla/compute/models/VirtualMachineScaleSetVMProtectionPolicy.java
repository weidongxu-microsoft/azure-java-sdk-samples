...
public final class VirtualMachineScaleSetVMProtectionPolicy {
     ...
     */
    public Boolean isProtectFromScaleIn() {
     ...
     */
    public VirtualMachineScaleSetVMProtectionPolicy setProtectFromScaleIn(Boolean protectFromScaleIn) {
     ...
     */
    public Boolean isProtectFromScaleSetActions() {
     ...
     * @return the VirtualMachineScaleSetVMProtectionPolicy object itself.
     */
    public VirtualMachineScaleSetVMProtectionPolicy setProtectFromScaleSetActions(Boolean protectFromScaleSetActions) {
