...
public class AvailabilitySet extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(AvailabilitySet.class);
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet setSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet setPlatformUpdateDomainCount(Integer platformUpdateDomainCount) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet setPlatformFaultDomainCount(Integer platformFaultDomainCount) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet setVirtualMachines(List<SubResource> virtualMachines) {
     ...
     * @return the AvailabilitySet object itself.
     */
    public AvailabilitySet setProximityPlacementGroup(SubResource proximityPlacementGroup) {
