...
public class VirtualMachineExtensionImage extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(VirtualMachineExtensionImage.class);
     ...
     * @return the VirtualMachineExtensionImage object itself.
     */
    public VirtualMachineExtensionImage setOperatingSystem(String operatingSystem) {
     ...
     * @return the VirtualMachineExtensionImage object itself.
     */
    public VirtualMachineExtensionImage setComputeRole(String computeRole) {
     ...
     * @return the VirtualMachineExtensionImage object itself.
     */
    public VirtualMachineExtensionImage setHandlerSchema(String handlerSchema) {
     ...
     * @return the VirtualMachineExtensionImage object itself.
     */
    public VirtualMachineExtensionImage setVmScaleSetEnabled(Boolean vmScaleSetEnabled) {
     ...
     * @return the VirtualMachineExtensionImage object itself.
     */
    public VirtualMachineExtensionImage setSupportsMultipleExtensions(Boolean supportsMultipleExtensions) {
