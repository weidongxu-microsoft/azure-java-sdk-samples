...
import com.azure.management.vanilla.compute.models.GalleryImageList;
...
public final class GalleryImagesImpl {
    private final ClientLogger logger = new ClientLogger(GalleryImagesImpl.class);
    ...
    /**
     * Initializes an instance of GalleryImagesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    GalleryImagesImpl(ComputeManagementClientImpl client) {
        this.service =
    ...
    private interface GalleryImagesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") GalleryImage galleryImage,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImage>> get(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImage>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImage>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
    ...
    public PollerFlux<PollResult<GalleryImage>, GalleryImage> beginCreateOrUpdate(
        ...
        return this
            .client
            .<GalleryImage, GalleryImage>getLroResultAsync(
                mono, this.client.getHttpPipeline(), GalleryImage.class, GalleryImage.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> createOrUpdateAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImage galleryImage) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, galleryName, galleryImageName, galleryImage);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> updateAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImageUpdate galleryImage) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, galleryName, galleryImageName, galleryImage);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImage>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> getAsync(String resourceGroupName, String galleryName, String galleryImageName) {
        return getWithResponseAsync(resourceGroupName, galleryName, galleryImageName)
            .flatMap(
                (Response<GalleryImage> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> getAsync(
        String resourceGroupName, String galleryName, String galleryImageName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImage>> listByGallerySinglePageAsync(
                ...
                context ->
                    service
                        .listByGallery(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<GalleryImage>>map(
                res ->
    ...
    public PagedFlux<GalleryImage> listByGalleryAsync(String resourceGroupName, String galleryName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GalleryImage> listByGalleryAsync(String resourceGroupName, String galleryName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImage>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImage galleryImage) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImage galleryImage) {
    ...
    public GalleryImage beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImage galleryImage) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, galleryName, galleryImageName, galleryImage)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImage>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImageUpdate galleryImage) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImage> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImageUpdate galleryImage) {
    ...
    public GalleryImage beginUpdateWithoutPolling(
        String resourceGroupName, String galleryName, String galleryImageName, GalleryImageUpdate galleryImage) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, galleryName, galleryImageName, galleryImage).block();
    }
    ...
    public GalleryImage beginUpdateWithoutPolling(
        ...
        GalleryImageUpdate galleryImage,
        Context context) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, galleryName, galleryImageName, galleryImage, context)
            .block();
    }
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String galleryName, String galleryImageName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, galleryName, galleryImageName)
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String galleryName, String galleryImageName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, galleryName, galleryImageName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String galleryName, String galleryImageName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, galleryName, galleryImageName).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String galleryName, String galleryImageName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, galleryName, galleryImageName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImage>> listByGalleryNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImage>> listByGalleryNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
