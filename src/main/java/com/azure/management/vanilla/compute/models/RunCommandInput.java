...
public final class RunCommandInput {
     ...
     */
    public RunCommandInput setCommandId(String commandId) {
     ...
     * @return the RunCommandInput object itself.
     */
    public RunCommandInput setScript(List<String> script) {
        this.script = script;
        return this;
    }
     ...
     * @return the RunCommandInput object itself.
     */
    public RunCommandInput setParameters(List<RunCommandInputParameter> parameters) {
