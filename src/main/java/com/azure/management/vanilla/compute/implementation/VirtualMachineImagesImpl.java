...
public final class VirtualMachineImagesImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineImagesImpl.class);
    ...
    private interface VirtualMachineImagesService {
        ...
        Mono<Response<VirtualMachineImage>> get(
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineImageResource>>> list(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineImageResource>>> listOffers(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @PathParam("publisherName") String publisherName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineImageResource>>> listPublishers(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<List<VirtualMachineImageResource>>> listSkus(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @PathParam("publisherName") String publisherName,
            @PathParam("offer") String offer,
    ...
    public Mono<Response<VirtualMachineImage>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineImage> getAsync(
        String location, String publisherName, String offer, String skus, String version) {
        return getWithResponseAsync(location, publisherName, offer, skus, version)
            .flatMap(
                (Response<VirtualMachineImage> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineImageResource>>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listAsync(
        String location, String publisherName, String offer, String skus, String expand, Integer top, String orderby) {
        return listWithResponseAsync(location, publisherName, offer, skus, expand, top, orderby)
            .flatMap(
                (Response<List<VirtualMachineImageResource>> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineImageResource>>> listOffersWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listOffersAsync(String location, String publisherName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listOffersAsync(
        String location, String publisherName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineImageResource>>> listPublishersWithResponseAsync(String location) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineImageResource>>> listPublishersWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listPublishersAsync(String location) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listPublishersAsync(String location, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<List<VirtualMachineImageResource>>> listSkusWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listSkusAsync(String location, String publisherName, String offer) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<List<VirtualMachineImageResource>> listSkusAsync(
        String location, String publisherName, String offer, Context context) {
