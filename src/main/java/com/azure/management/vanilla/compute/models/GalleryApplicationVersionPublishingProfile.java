...
public final class GalleryApplicationVersionPublishingProfile extends GalleryArtifactPublishingProfileBase {
     ...
     */
    public GalleryApplicationVersionPublishingProfile setSource(UserArtifactSource source) {
        this.source = source;
        return this;
    }
     ...
     * @return the GalleryApplicationVersionPublishingProfile object itself.
     */
    public GalleryApplicationVersionPublishingProfile setContentType(String contentType) {
     ...
     * @return the GalleryApplicationVersionPublishingProfile object itself.
     */
    public GalleryApplicationVersionPublishingProfile setEnableHealthCheck(Boolean enableHealthCheck) {
