...
@JsonFlatten
@Fluent
public class DedicatedHost extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DedicatedHost.class);
     ...
     * @return the DedicatedHost object itself.
     */
    public DedicatedHost setSku(Sku sku) {
        this.sku = sku;
        return this;
    }
     ...
     * @return the DedicatedHost object itself.
     */
    public DedicatedHost setPlatformFaultDomain(Integer platformFaultDomain) {
     ...
     */
    public Boolean isAutoReplaceOnFailure() {
     ...
     * @return the DedicatedHost object itself.
     */
    public DedicatedHost setAutoReplaceOnFailure(Boolean autoReplaceOnFailure) {
     ...
     */
    public DedicatedHostLicenseTypes getLicenseType() {
     ...
     * @return the DedicatedHost object itself.
     */
    public DedicatedHost setLicenseType(DedicatedHostLicenseTypes licenseType) {
    ...
    public void validate() {
        if (getSku() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException("Missing required property sku in model DedicatedHost"));
        } else {
            getSku().validate();
        }
