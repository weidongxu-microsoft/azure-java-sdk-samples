...
public final class VirtualMachineScaleSetVMExtensionsImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineScaleSetVMExtensionsImpl.class);
    ...
    private interface VirtualMachineScaleSetVMExtensionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") VirtualMachineExtension extensionParameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineExtension>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineExtensionsListResult>> list(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineExtension>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<VirtualMachineExtension>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("instanceId") String instanceId,
    ...
    public PollerFlux<PollResult<VirtualMachineExtension>, VirtualMachineExtension> beginCreateOrUpdate(
        ...
        return this
            .client
            .<VirtualMachineExtension, VirtualMachineExtension>getLroResultAsync(
                mono, this.client.getHttpPipeline(), VirtualMachineExtension.class, VirtualMachineExtension.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtension> createOrUpdateAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtension> updateAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineExtension>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineExtensionsListResult>> listWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtensionsListResult> listAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, String expand) {
        return listWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, expand)
            .flatMap(
                (Response<VirtualMachineExtensionsListResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public Mono<VirtualMachineExtensionsListResult> listAsync(
        String resourceGroupName, String vmScaleSetName, String instanceId, String expand, Context context) {
        return listWithResponseAsync(resourceGroupName, vmScaleSetName, instanceId, expand, context)
            .flatMap(
                (Response<VirtualMachineExtensionsListResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineExtension>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtension> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineExtension>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineExtension> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String instanceId,
        String vmExtensionName,
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        ...
        return beginDeleteWithoutPollingWithResponseAsync(
                resourceGroupName, vmScaleSetName, instanceId, vmExtensionName)
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String vmScaleSetName, String instanceId, String vmExtensionName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, vmScaleSetName, instanceId, vmExtensionName).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String vmScaleSetName, String instanceId, String vmExtensionName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, vmScaleSetName, instanceId, vmExtensionName, context).block();
    }
}
