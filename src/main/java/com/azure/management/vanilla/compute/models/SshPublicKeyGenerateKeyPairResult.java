...
@Fluent
public final class SshPublicKeyGenerateKeyPairResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(SshPublicKeyGenerateKeyPairResult.class);
     ...
     * @return the SshPublicKeyGenerateKeyPairResult object itself.
     */
    public SshPublicKeyGenerateKeyPairResult setPrivateKey(String privateKey) {
     ...
     * @return the SshPublicKeyGenerateKeyPairResult object itself.
     */
    public SshPublicKeyGenerateKeyPairResult setPublicKey(String publicKey) {
     ...
     * @return the SshPublicKeyGenerateKeyPairResult object itself.
     */
    public SshPublicKeyGenerateKeyPairResult setId(String id) {
        this.id = id;
        return this;
    }
            ...
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property privateKey in model SshPublicKeyGenerateKeyPairResult"));
        }
        if (getPublicKey() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property publicKey in model SshPublicKeyGenerateKeyPairResult"));
        }
        if (getId() == null) {
            throw logger
                .logExceptionAsError(
                    new IllegalArgumentException(
                        "Missing required property id in model SshPublicKeyGenerateKeyPairResult"));
        }
    }
}
