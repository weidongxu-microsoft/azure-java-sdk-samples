...
public class DedicatedHostGroupUpdate extends UpdateResource {
     ...
     */
    public DedicatedHostGroupUpdate setZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
     ...
     * @return the DedicatedHostGroupUpdate object itself.
     */
    public DedicatedHostGroupUpdate setPlatformFaultDomainCount(Integer platformFaultDomainCount) {
