...
public class Gallery extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(Gallery.class);
     ...
     * @return the Gallery object itself.
     */
     ...
     * @return the Gallery object itself.
     */
    public Gallery setIdentifier(GalleryIdentifier identifier) {
