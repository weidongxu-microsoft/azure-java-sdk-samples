...
public final class GalleryImageVersionStorageProfile {
     ...
     */
    public GalleryImageVersionStorageProfile setSource(GalleryArtifactVersionSource source) {
        this.source = source;
        return this;
    }
     ...
     */
    public GalleryDiskImage getOsDiskImage() {
     ...
     * @return the GalleryImageVersionStorageProfile object itself.
     */
    public GalleryImageVersionStorageProfile setOsDiskImage(GalleryDiskImage osDiskImage) {
     ...
     * @return the GalleryImageVersionStorageProfile object itself.
     */
    public GalleryImageVersionStorageProfile setDataDiskImages(List<GalleryDataDiskImage> dataDiskImages) {
