...
public final class ManagedDiskParameters extends SubResource {
     ...
     */
    public ManagedDiskParameters setStorageAccountType(StorageAccountTypes storageAccountType) {
     ...
     * @return the ManagedDiskParameters object itself.
     */
    public ManagedDiskParameters setDiskEncryptionSet(SubResource diskEncryptionSet) {
