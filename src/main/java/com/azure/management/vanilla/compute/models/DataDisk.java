...
public final class DataDisk {
     ...
     * @return the DataDisk object itself.
     */
    public DataDisk setWriteAcceleratorEnabled(Boolean writeAcceleratorEnabled) {
     ...
     * @return the DataDisk object itself.
     */
    public DataDisk setManagedDisk(ManagedDiskParameters managedDisk) {
     ...
     * @return the DataDisk object itself.
     */
    public DataDisk setToBeDetached(Boolean toBeDetached) {
