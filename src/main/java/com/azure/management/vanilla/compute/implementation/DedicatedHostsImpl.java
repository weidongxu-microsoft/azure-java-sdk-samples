...
import com.azure.management.vanilla.compute.models.DedicatedHostListResult;
...
public final class DedicatedHostsImpl {
    private final ClientLogger logger = new ClientLogger(DedicatedHostsImpl.class);
    ...
    private interface DedicatedHostsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") DedicatedHost parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DedicatedHost>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("hostGroupName") String hostGroupName,
            @PathParam("hostName") String hostname,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DedicatedHost>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("hostGroupName") String hostGroupName,
            @PathParam("hostName") String hostname,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<DedicatedHost>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("hostGroupName") String hostGroupName,
            @PathParam("hostName") String hostname,
    ...
    public PollerFlux<PollResult<DedicatedHost>, DedicatedHost> beginCreateOrUpdate(
        ...
        return this
            .client
            .<DedicatedHost, DedicatedHost>getLroResultAsync(
                mono, this.client.getHttpPipeline(), DedicatedHost.class, DedicatedHost.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DedicatedHost> createOrUpdateAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHost parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, hostGroupName, hostname, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DedicatedHost> updateAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHostUpdate parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, hostGroupName, hostname, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DedicatedHost>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DedicatedHost> getAsync(String resourceGroupName, String hostGroupName, String hostname) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<DedicatedHost>> listByHostGroupSinglePageAsync(
                ...
                context ->
                    service
                        .listByHostGroup(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<DedicatedHost>>map(
                res ->
    ...
    public PagedFlux<DedicatedHost> listByHostGroupAsync(String resourceGroupName, String hostGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<DedicatedHost> listByHostGroupAsync(
        String resourceGroupName, String hostGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DedicatedHost>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHost parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DedicatedHost> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHost parameters) {
    ...
    public DedicatedHost beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHost parameters) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, hostGroupName, hostname, parameters).block();
    }
    ...
    public DedicatedHost beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHost parameters, Context context) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, hostGroupName, hostname, parameters, context)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<DedicatedHost>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHostUpdate parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<DedicatedHost> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHostUpdate parameters) {
        return beginUpdateWithoutPollingWithResponseAsync(resourceGroupName, hostGroupName, hostname, parameters)
            .flatMap(
                (Response<DedicatedHost> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public DedicatedHost beginUpdateWithoutPolling(
        String resourceGroupName, String hostGroupName, String hostname, DedicatedHostUpdate parameters) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, hostGroupName, hostname, parameters).block();
    }
    ...
    public DedicatedHost beginUpdateWithoutPolling(
        ...
        DedicatedHostUpdate parameters,
        Context context) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, hostGroupName, hostname, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String hostGroupName, String hostname) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, hostGroupName, hostname)
    ...
    public Mono<Void> beginDeleteWithoutPollingAsync(
        String resourceGroupName, String hostGroupName, String hostname, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, hostGroupName, hostname, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String hostGroupName, String hostname) {
        beginDeleteWithoutPollingAsync(resourceGroupName, hostGroupName, hostname).block();
    }
    ...
    public void beginDeleteWithoutPolling(
        String resourceGroupName, String hostGroupName, String hostname, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, hostGroupName, hostname, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<DedicatedHost>> listByHostGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<DedicatedHost>> listByHostGroupNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
