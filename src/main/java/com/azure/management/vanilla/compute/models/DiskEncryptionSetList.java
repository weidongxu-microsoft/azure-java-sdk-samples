...
public final class DiskEncryptionSetList {
    ...
    private List<DiskEncryptionSet> value;
     ...
     */
    public List<DiskEncryptionSet> getValue() {
        return this.value;
    }
     ...
     */
    public DiskEncryptionSetList setValue(List<DiskEncryptionSet> value) {
        this.value = value;
        return this;
    }
     ...
     * @return the DiskEncryptionSetList object itself.
     */
    public DiskEncryptionSetList setNextLink(String nextLink) {
