...
import com.azure.management.vanilla.compute.models.GalleryImageVersionList;
...
public final class GalleryImageVersionsImpl {
    private final ClientLogger logger = new ClientLogger(GalleryImageVersionsImpl.class);
    ...
    /**
     * Initializes an instance of GalleryImageVersionsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    GalleryImageVersionsImpl(ComputeManagementClientImpl client) {
        this.service =
            RestProxy
    ...
    private interface GalleryImageVersionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") GalleryImageVersion galleryImageVersion,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImageVersion>> get(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImageVersion>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<GalleryImageVersion>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
    ...
    public PollerFlux<PollResult<GalleryImageVersion>, GalleryImageVersion> beginCreateOrUpdate(
        ...
        return this
            .client
            .<GalleryImageVersion, GalleryImageVersion>getLroResultAsync(
                mono, this.client.getHttpPipeline(), GalleryImageVersion.class, GalleryImageVersion.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImageVersion> createOrUpdateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImageVersion> updateAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImageVersion>> getWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImageVersion> getAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
        ...
        return getWithResponseAsync(resourceGroupName, galleryName, galleryImageName, galleryImageVersionName, expand)
            .flatMap(
                (Response<GalleryImageVersion> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImageVersion>> listByGalleryImageSinglePageAsync(
                ...
                context ->
                    service
                        .listByGalleryImage(
                            ...
                            apiVersion,
                            context))
            .<PagedResponse<GalleryImageVersion>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImageVersion>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImageVersion> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GalleryImageVersion>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GalleryImageVersion> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String galleryName,
        String galleryImageName,
        String galleryImageVersionName,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImageVersion>> listByGalleryImageNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GalleryImageVersion>> listByGalleryImageNextSinglePageAsync(
