...
@Immutable
public final class UpgradeOperationHistoricalStatusInfo {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(UpgradeOperationHistoricalStatusInfo.class);
