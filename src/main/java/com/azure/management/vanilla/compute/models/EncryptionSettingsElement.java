...
public final class EncryptionSettingsElement {
     ...
     */
    public EncryptionSettingsElement setDiskEncryptionKey(KeyVaultAndSecretReference diskEncryptionKey) {
     ...
     * @return the EncryptionSettingsElement object itself.
     */
    public EncryptionSettingsElement setKeyEncryptionKey(KeyVaultAndKeyReference keyEncryptionKey) {
