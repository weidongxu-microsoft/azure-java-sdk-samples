...
public final class ContainerServiceLinuxProfile {
     ...
     */
    public ContainerServiceLinuxProfile setAdminUsername(String adminUsername) {
     ...
     * @return the ContainerServiceLinuxProfile object itself.
     */
    public ContainerServiceLinuxProfile setSsh(ContainerServiceSshConfiguration ssh) {
        this.ssh = ssh;
        return this;
    }
