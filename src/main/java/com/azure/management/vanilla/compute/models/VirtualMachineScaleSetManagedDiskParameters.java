...
public final class VirtualMachineScaleSetManagedDiskParameters {
     ...
     */
    public VirtualMachineScaleSetManagedDiskParameters setStorageAccountType(StorageAccountTypes storageAccountType) {
     ...
     * @return the VirtualMachineScaleSetManagedDiskParameters object itself.
     */
    public VirtualMachineScaleSetManagedDiskParameters setDiskEncryptionSet(SubResource diskEncryptionSet) {
