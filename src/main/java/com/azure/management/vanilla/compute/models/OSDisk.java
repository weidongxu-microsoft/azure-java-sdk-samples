...
public final class OSDisk {
     ...
     * @return the OSDisk object itself.
     */
    public OSDisk setDiffDiskSettings(DiffDiskSettings diffDiskSettings) {
     ...
     * @return the OSDisk object itself.
     */
    public OSDisk setManagedDisk(ManagedDiskParameters managedDisk) {
    ...
    public void validate() {
        if (getEncryptionSettings() != null) {
            getEncryptionSettings().validate();
        }
        if (getVhd() != null) {
            getVhd().validate();
        }
