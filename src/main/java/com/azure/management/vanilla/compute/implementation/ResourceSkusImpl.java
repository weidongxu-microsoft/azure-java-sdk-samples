...
import com.azure.management.vanilla.compute.models.ResourceSkusResult;
...
public final class ResourceSkusImpl {
    private final ClientLogger logger = new ClientLogger(ResourceSkusImpl.class);
    ...
    /**
     * Initializes an instance of ResourceSkusImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ResourceSkusImpl(ComputeManagementClientImpl client) {
        this.service =
    ...
    public Mono<PagedResponse<ResourceSku>> listSinglePageAsync(String filter) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.list(this.client.getHost(), apiVersion, this.client.getSubscriptionId(), filter, context))
            .<PagedResponse<ResourceSku>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ResourceSku>> listSinglePageAsync(String filter, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
        ...
        final String apiVersion = "2019-04-01";
        return service
            .list(this.client.getHost(), apiVersion, this.client.getSubscriptionId(), filter, context)
            .map(
                res ->
                    new PagedResponseBase<>(
                        res.getRequest(),
    ...
    public PagedFlux<ResourceSku> listAsync(String filter) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ResourceSku> listAsync(String filter, Context context) {
