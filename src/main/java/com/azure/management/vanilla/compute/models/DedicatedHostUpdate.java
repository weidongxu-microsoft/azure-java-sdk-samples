...
public class DedicatedHostUpdate extends UpdateResource {
     ...
     */
    public DedicatedHostUpdate setPlatformFaultDomain(Integer platformFaultDomain) {
     ...
     * @return the DedicatedHostUpdate object itself.
     */
    public DedicatedHostUpdate setAutoReplaceOnFailure(Boolean autoReplaceOnFailure) {
     ...
     * @return the DedicatedHostUpdate object itself.
     */
    public DedicatedHostUpdate setLicenseType(DedicatedHostLicenseTypes licenseType) {
