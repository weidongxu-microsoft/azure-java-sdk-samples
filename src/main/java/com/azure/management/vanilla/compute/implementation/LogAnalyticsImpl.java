...
public final class LogAnalyticsImpl {
    private final ClientLogger logger = new ClientLogger(LogAnalyticsImpl.class);
    ...
    private interface LogAnalyticsService {
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LogAnalyticsOperationResult>> beginExportRequestRateByIntervalWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<LogAnalyticsOperationResult>> beginExportThrottledRequestsWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("location") String location,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
    ...
    public PollerFlux<PollResult<LogAnalyticsOperationResult>, LogAnalyticsOperationResult>
        ...
        return this
            .client
            .<LogAnalyticsOperationResult, LogAnalyticsOperationResult>getLroResultAsync(
                mono,
                this.client.getHttpPipeline(),
                LogAnalyticsOperationResult.class,
                LogAnalyticsOperationResult.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LogAnalyticsOperationResult> exportRequestRateByIntervalAsync(
        String location, RequestRateByIntervalInput parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = exportRequestRateByIntervalWithResponseAsync(location, parameters);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LogAnalyticsOperationResult> exportThrottledRequestsAsync(
        String location, LogAnalyticsInputBase parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = exportThrottledRequestsWithResponseAsync(location, parameters);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<LogAnalyticsOperationResult>> beginExportRequestRateByIntervalWithoutPollingWithResponseAsync(
        String location, RequestRateByIntervalInput parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LogAnalyticsOperationResult> beginExportRequestRateByIntervalWithoutPollingAsync(
        String location, RequestRateByIntervalInput parameters) {
        return beginExportRequestRateByIntervalWithoutPollingWithResponseAsync(location, parameters)
            .flatMap(
                (Response<LogAnalyticsOperationResult> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<LogAnalyticsOperationResult>> beginExportThrottledRequestsWithoutPollingWithResponseAsync(
        String location, LogAnalyticsInputBase parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<LogAnalyticsOperationResult> beginExportThrottledRequestsWithoutPollingAsync(
        String location, LogAnalyticsInputBase parameters) {
