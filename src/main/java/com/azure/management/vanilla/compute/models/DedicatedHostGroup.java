...
@JsonFlatten
@Fluent
public class DedicatedHostGroup extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DedicatedHostGroup.class);
     ...
     * @return the DedicatedHostGroup object itself.
     */
    public DedicatedHostGroup setZones(List<String> zones) {
        this.zones = zones;
        return this;
    }
     ...
     * @return the DedicatedHostGroup object itself.
     */
    public DedicatedHostGroup setPlatformFaultDomainCount(Integer platformFaultDomainCount) {
