...
public final class ContainerServiceWindowsProfile {
     ...
     */
    public ContainerServiceWindowsProfile setAdminUsername(String adminUsername) {
     ...
     * @return the ContainerServiceWindowsProfile object itself.
     */
    public ContainerServiceWindowsProfile setAdminPassword(String adminPassword) {
