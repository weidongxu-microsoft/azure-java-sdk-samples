...
@JsonFlatten
@Fluent
public class DiskEncryptionSet extends Resource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DiskEncryptionSet.class);
     ...
     */
    public EncryptionSetIdentity getIdentity() {
     ...
     * @return the DiskEncryptionSet object itself.
     */
    public DiskEncryptionSet setIdentity(EncryptionSetIdentity identity) {
     ...
     * @return the DiskEncryptionSet object itself.
     */
    public DiskEncryptionSet setActiveKey(KeyVaultAndKeyReference activeKey) {
    ...
    public void validate() {
        ...
        if (getActiveKey() != null) {
            getActiveKey().validate();
        }
        if (getPreviousKeys() != null) {
            getPreviousKeys().forEach(e -> e.validate());
        }
    }
}
