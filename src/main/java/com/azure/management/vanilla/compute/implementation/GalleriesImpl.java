...
import com.azure.management.vanilla.compute.models.GalleryList;
...
public final class GalleriesImpl
    implements InnerSupportsGet<Gallery>, InnerSupportsListing<Gallery>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(GalleriesImpl.class);
    ...
    /**
     * Initializes an instance of GalleriesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    GalleriesImpl(ComputeManagementClientImpl client) {
        this.service =
    ...
    private interface GalleriesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") Gallery gallery,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Gallery>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Gallery>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ApiErrorException.class)
        Mono<Response<Gallery>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("galleryName") String galleryName,
    ...
    public PollerFlux<PollResult<Gallery>, Gallery> beginCreateOrUpdate(
        ...
        return this
            .client
            .<Gallery, Gallery>getLroResultAsync(mono, this.client.getHttpPipeline(), Gallery.class, Gallery.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> createOrUpdateAsync(String resourceGroupName, String galleryName, Gallery gallery) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, galleryName, gallery);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> createOrUpdateAsync(
        String resourceGroupName, String galleryName, Gallery gallery, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, galleryName, gallery, context);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> updateAsync(String resourceGroupName, String galleryName, GalleryUpdate gallery) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, galleryName, gallery);
        return this
            .client
            .<Gallery, Gallery>getLroResultAsync(mono, this.client.getHttpPipeline(), Gallery.class, Gallery.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> updateAsync(
        String resourceGroupName, String galleryName, GalleryUpdate gallery, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateWithResponseAsync(resourceGroupName, galleryName, gallery, context);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Gallery>> getByResourceGroupWithResponseAsync(String resourceGroupName, String galleryName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Gallery>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> getByResourceGroupAsync(String resourceGroupName, String galleryName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, galleryName)
            .flatMap(
                (Response<Gallery> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> getByResourceGroupAsync(String resourceGroupName, String galleryName, Context context) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, galleryName, context)
            .flatMap(
                (Response<Gallery> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Gallery getByResourceGroup(String resourceGroupName, String galleryName, Context context) {
        return getByResourceGroupAsync(resourceGroupName, galleryName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> deleteAsync(String resourceGroupName, String galleryName, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono = deleteWithResponseAsync(resourceGroupName, galleryName, context);
        return this
            .client
            .<Void, Void>getLroResultAsync(mono, this.client.getHttpPipeline(), Void.class, Void.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listByResourceGroupSinglePageAsync(String resourceGroupName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Gallery> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Gallery> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Gallery>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String galleryName, Gallery gallery) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, Gallery gallery) {
        return beginCreateOrUpdateWithoutPollingWithResponseAsync(resourceGroupName, galleryName, gallery)
            .flatMap(
                (Response<Gallery> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Mono<Gallery> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, Gallery gallery, Context context) {
        return beginCreateOrUpdateWithoutPollingWithResponseAsync(resourceGroupName, galleryName, gallery, context)
            .flatMap(
                (Response<Gallery> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Gallery beginCreateOrUpdateWithoutPolling(String resourceGroupName, String galleryName, Gallery gallery) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, galleryName, gallery).block();
    }
    ...
    public Gallery beginCreateOrUpdateWithoutPolling(
        String resourceGroupName, String galleryName, Gallery gallery, Context context) {
        return beginCreateOrUpdateWithoutPollingAsync(resourceGroupName, galleryName, gallery, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Gallery>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String galleryName, GalleryUpdate gallery) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Gallery> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, GalleryUpdate gallery) {
        return beginUpdateWithoutPollingWithResponseAsync(resourceGroupName, galleryName, gallery)
            .flatMap(
                (Response<Gallery> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Mono<Gallery> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String galleryName, GalleryUpdate gallery, Context context) {
        return beginUpdateWithoutPollingWithResponseAsync(resourceGroupName, galleryName, gallery, context)
            .flatMap(
                (Response<Gallery> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public Gallery beginUpdateWithoutPolling(String resourceGroupName, String galleryName, GalleryUpdate gallery) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, galleryName, gallery).block();
    }
    ...
    public Gallery beginUpdateWithoutPolling(
        String resourceGroupName, String galleryName, GalleryUpdate gallery, Context context) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, galleryName, gallery, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String galleryName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, galleryName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, String galleryName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, galleryName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String galleryName) {
        beginDeleteWithoutPollingAsync(resourceGroupName, galleryName).block();
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, String galleryName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, galleryName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listByResourceGroupNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Gallery>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
