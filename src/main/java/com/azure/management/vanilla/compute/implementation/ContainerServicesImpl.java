...
import com.azure.management.vanilla.compute.models.ContainerServiceListResult;
import java.nio.ByteBuffer;
import reactor.core.publisher.Flux;
import reactor.core.publisher.Mono;

/** An instance of this class provides access to all the operations defined in ContainerServices. */
public final class ContainerServicesImpl
    implements InnerSupportsGet<ContainerService>, InnerSupportsListing<ContainerService>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(ContainerServicesImpl.class);
    ...
    /**
     * Initializes an instance of ContainerServicesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ContainerServicesImpl(ComputeManagementClientImpl client) {
        this.service =
    ...
    private interface ContainerServicesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ContainerService parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ContainerService>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("containerServiceName") String containerServiceName,
            @QueryParam("api-version") String apiVersion,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ContainerService>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("containerServiceName") String containerServiceName,
            @QueryParam("api-version") String apiVersion,
    ...
    public Mono<PagedResponse<ContainerService>> listSinglePageAsync() {
        ...
        return FluxUtil
            ...
            .<PagedResponse<ContainerService>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ContainerService> listAsync(Context context) {
    ...
    public PollerFlux<PollResult<ContainerService>, ContainerService> beginCreateOrUpdate(
        ...
        return this
            .client
            .<ContainerService, ContainerService>getLroResultAsync(
                mono, this.client.getHttpPipeline(), ContainerService.class, ContainerService.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ContainerService> createOrUpdateAsync(
        String resourceGroupName, String containerServiceName, ContainerService parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, containerServiceName, parameters);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ContainerService>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ContainerService> getByResourceGroupAsync(String resourceGroupName, String containerServiceName) {
        return getByResourceGroupWithResponseAsync(resourceGroupName, containerServiceName)
            .flatMap(
                (Response<ContainerService> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ContainerService> getByResourceGroupAsync(
        String resourceGroupName, String containerServiceName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listByResourceGroupSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ContainerService> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ContainerService>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String containerServiceName, ContainerService parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ContainerService> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String containerServiceName, ContainerService parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ContainerService>> listByResourceGroupNextSinglePageAsync(
