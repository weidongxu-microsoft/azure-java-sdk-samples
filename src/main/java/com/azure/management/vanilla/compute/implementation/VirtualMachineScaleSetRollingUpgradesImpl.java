...
public final class VirtualMachineScaleSetRollingUpgradesImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineScaleSetRollingUpgradesImpl.class);
    ...
    private interface VirtualMachineScaleSetRollingUpgradesService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<RollingUpgradeStatusInfo>> getLatest(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<RollingUpgradeStatusInfo>> getLatestWithResponseAsync(
        String resourceGroupName, String vmScaleSetName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<RollingUpgradeStatusInfo> getLatestAsync(String resourceGroupName, String vmScaleSetName) {
        return getLatestWithResponseAsync(resourceGroupName, vmScaleSetName)
            .flatMap(
                (Response<RollingUpgradeStatusInfo> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<RollingUpgradeStatusInfo> getLatestAsync(
        String resourceGroupName, String vmScaleSetName, Context context) {
