...
import com.azure.management.vanilla.compute.models.VirtualMachineScaleSetExtensionListResult;
...
public final class VirtualMachineScaleSetExtensionsImpl {
    private final ClientLogger logger = new ClientLogger(VirtualMachineScaleSetExtensionsImpl.class);
    ...
    /**
     * Initializes an instance of VirtualMachineScaleSetExtensionsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    VirtualMachineScaleSetExtensionsImpl(ComputeManagementClientImpl client) {
        this.service =
            RestProxy
                .create(
    ...
    private interface VirtualMachineScaleSetExtensionsService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") VirtualMachineScaleSetExtension extensionParameters,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetExtension>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("vmssExtensionName") String vmssExtensionName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetExtension>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("vmssExtensionName") String vmssExtensionName,
        ...
        @ExpectedResponses({200, 201})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<VirtualMachineScaleSetExtension>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("vmScaleSetName") String vmScaleSetName,
            @PathParam("vmssExtensionName") String vmssExtensionName,
    ...
    public PollerFlux<PollResult<VirtualMachineScaleSetExtension>, VirtualMachineScaleSetExtension> beginCreateOrUpdate(
        ...
        return this
            .client
            .<VirtualMachineScaleSetExtension, VirtualMachineScaleSetExtension>getLroResultAsync(
                mono,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetExtension> createOrUpdateAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtension extensionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetExtension> updateAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtensionUpdate extensionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetExtension>> getWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetExtension> getAsync(
        String resourceGroupName, String vmScaleSetName, String vmssExtensionName, String expand) {
        return getWithResponseAsync(resourceGroupName, vmScaleSetName, vmssExtensionName, expand)
            .flatMap(
                (Response<VirtualMachineScaleSetExtension> res) -> {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetExtension>> listSinglePageAsync(
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<VirtualMachineScaleSetExtension>>map(
                res ->
    ...
    public PagedFlux<VirtualMachineScaleSetExtension> listAsync(String resourceGroupName, String vmScaleSetName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<VirtualMachineScaleSetExtension> listAsync(
        String resourceGroupName, String vmScaleSetName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetExtension>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtension extensionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetExtension> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtension extensionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<VirtualMachineScaleSetExtension>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtensionUpdate extensionParameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<VirtualMachineScaleSetExtension> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String vmScaleSetName,
        String vmssExtensionName,
        VirtualMachineScaleSetExtensionUpdate extensionParameters) {
    ...
    public VirtualMachineScaleSetExtension beginUpdateWithoutPolling(
        ...
        String vmssExtensionName,
        VirtualMachineScaleSetExtensionUpdate extensionParameters) {
        return beginUpdateWithoutPollingAsync(resourceGroupName, vmScaleSetName, vmssExtensionName, extensionParameters)
            .block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetExtension>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<VirtualMachineScaleSetExtension>> listNextSinglePageAsync(
