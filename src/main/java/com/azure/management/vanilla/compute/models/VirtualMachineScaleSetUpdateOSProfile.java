...
public final class VirtualMachineScaleSetUpdateOSProfile {
     ...
     */
    public VirtualMachineScaleSetUpdateOSProfile setCustomData(String customData) {
     ...
     * @return the VirtualMachineScaleSetUpdateOSProfile object itself.
     */
    public VirtualMachineScaleSetUpdateOSProfile setWindowsConfiguration(WindowsConfiguration windowsConfiguration) {
     ...
     * @return the VirtualMachineScaleSetUpdateOSProfile object itself.
     */
    public VirtualMachineScaleSetUpdateOSProfile setLinuxConfiguration(LinuxConfiguration linuxConfiguration) {
     ...
     * @return the VirtualMachineScaleSetUpdateOSProfile object itself.
     */
    public VirtualMachineScaleSetUpdateOSProfile setSecrets(List<VaultSecretGroup> secrets) {
    ...
    public void validate() {
        if (getWindowsConfiguration() != null) {
            getWindowsConfiguration().validate();
        }
        if (getLinuxConfiguration() != null) {
            getLinuxConfiguration().validate();
        }
        if (getSecrets() != null) {
            getSecrets().forEach(e -> e.validate());
        }
    }
}
