...
import com.azure.management.vanilla.compute.models.DiskList;
...
public final class DisksImpl implements InnerSupportsGet<Disk>, InnerSupportsListing<Disk>, InnerSupportsDelete<Void> {
    private final ClientLogger logger = new ClientLogger(DisksImpl.class);
    ...
    /**
     * Initializes an instance of DisksImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    DisksImpl(ComputeManagementClientImpl client) {
    ...
    private interface DisksService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @BodyParam("application/json") Disk disk,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Disk>> getByResourceGroup(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("diskName") String diskName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Disk>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("diskName") String diskName,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<Disk>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("diskName") String diskName,
    ...
    public PollerFlux<PollResult<Disk>, Disk> beginCreateOrUpdate(
        ...
        return this.client.<Disk, Disk>getLroResultAsync(mono, this.client.getHttpPipeline(), Disk.class, Disk.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> createOrUpdateAsync(String resourceGroupName, String diskName, Disk disk) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateWithResponseAsync(resourceGroupName, diskName, disk);
        return this
            .client
            .<Disk, Disk>getLroResultAsync(mono, this.client.getHttpPipeline(), Disk.class, Disk.class)
            .last()
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> createOrUpdateAsync(String resourceGroupName, String diskName, Disk disk, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            createOrUpdateWithResponseAsync(resourceGroupName, diskName, disk, context);
        return this
            .client
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> updateAsync(String resourceGroupName, String diskName, DiskUpdate disk) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, diskName, disk);
        return this
            .client
            .<Disk, Disk>getLroResultAsync(mono, this.client.getHttpPipeline(), Disk.class, Disk.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> updateAsync(String resourceGroupName, String diskName, DiskUpdate disk, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateWithResponseAsync(resourceGroupName, diskName, disk, context);
        return this
            .client
            .<Disk, Disk>getLroResultAsync(mono, this.client.getHttpPipeline(), Disk.class, Disk.class)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Disk>> getByResourceGroupWithResponseAsync(String resourceGroupName, String diskName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Disk>> getByResourceGroupWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> getByResourceGroupAsync(String resourceGroupName, String diskName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> getByResourceGroupAsync(String resourceGroupName, String diskName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listByResourceGroupSinglePageAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listByResourceGroupSinglePageAsync(String resourceGroupName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<Disk> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Disk> listByResourceGroupAsync(String resourceGroupName, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listSinglePageAsync() {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listSinglePageAsync(Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Disk> listAsync() {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<Disk> listAsync(Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Disk>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String diskName, Disk disk) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> beginCreateOrUpdateWithoutPollingAsync(String resourceGroupName, String diskName, Disk disk) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName, String diskName, Disk disk, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Disk>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName, String diskName, DiskUpdate disk) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> beginUpdateWithoutPollingAsync(String resourceGroupName, String diskName, DiskUpdate disk) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Disk> beginUpdateWithoutPollingAsync(
        String resourceGroupName, String diskName, DiskUpdate disk, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listByResourceGroupNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<Disk>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
