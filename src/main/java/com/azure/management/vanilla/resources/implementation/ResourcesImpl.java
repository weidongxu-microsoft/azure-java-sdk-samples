...
import com.azure.management.vanilla.resources.models.ResourceListResult;
...
public final class ResourcesImpl implements InnerSupportsListing<GenericResourceExpanded> {
    private final ClientLogger logger = new ClientLogger(ResourcesImpl.class);
    ...
    /**
     * Initializes an instance of ResourcesImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ResourcesImpl(ResourceManagementClientImpl client) {
        this.service =
    ...
    private interface ResourcesService {
        ...
        Mono<Response<Flux<ByteBuffer>>> createOrUpdate(
            ...
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") GenericResource parameters,
            Context context);
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderNamespace") String resourceProviderNamespace,
            @PathParam(value = "parentResourcePath", encoded = true) String parentResourcePath,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> getById(
            @HostParam("$host") String host,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @QueryParam("api-version") String apiVersion,
            Context context);
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> beginCreateOrUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderNamespace") String resourceProviderNamespace,
            @PathParam(value = "parentResourcePath", encoded = true) String parentResourcePath,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> beginUpdateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @PathParam("resourceProviderNamespace") String resourceProviderNamespace,
            @PathParam(value = "parentResourcePath", encoded = true) String parentResourcePath,
        ...
        @ExpectedResponses({200, 201, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> beginCreateOrUpdateByIdWithoutPolling(
            @HostParam("$host") String host,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") GenericResource parameters,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<GenericResource>> beginUpdateByIdWithoutPolling(
            @HostParam("$host") String host,
            @PathParam(value = "resourceId", encoded = true) String resourceId,
            @QueryParam("api-version") String apiVersion,
            @BodyParam("application/json") GenericResource parameters,
    ...
    public Mono<PagedResponse<GenericResourceExpanded>> listByResourceGroupSinglePageAsync(
                ...
                context ->
                    service
                        .listByResourceGroup(
                            ...
                            context))
            .<PagedResponse<GenericResourceExpanded>>map(
                res ->
    ...
    public PagedFlux<GenericResourceExpanded> listByResourceGroupAsync(
        String resourceGroupName, String filter, String expand, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GenericResourceExpanded> listByResourceGroupAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listSinglePageAsync(String filter, String expand, Integer top) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GenericResourceExpanded> listAsync(String filter, String expand, Integer top) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GenericResourceExpanded> listAsync(String filter, String expand, Integer top, Context context) {
        return new PagedFlux<>(
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<GenericResourceExpanded> listAsync() {
        final String filter = null;
        final String expand = null;
        final Integer top = null;
        final Context context = null;
    ...
    public PollerFlux<PollResult<GenericResource>, GenericResource> beginCreateOrUpdate(
        ...
        return this
            .client
            .<GenericResource, GenericResource>getLroResultAsync(
                mono, this.client.getHttpPipeline(), GenericResource.class, GenericResource.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> createOrUpdateAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> updateAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> getWithResponseAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> getAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
    ...
    public Mono<Response<Flux<ByteBuffer>>> deleteByIdWithResponseAsync(
        ...
        return service.deleteById(this.client.getHost(), resourceId, apiVersion, context);
    }
    ...
    public Mono<Response<Flux<ByteBuffer>>> createOrUpdateByIdWithResponseAsync(
        ...
        return service.createOrUpdateById(this.client.getHost(), resourceId, apiVersion, parameters, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> createOrUpdateByIdAsync(
        String resourceId, String apiVersion, GenericResource parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = createOrUpdateByIdWithResponseAsync(resourceId, apiVersion, parameters);
        return this
            .client
    ...
    public Mono<Response<Flux<ByteBuffer>>> updateByIdWithResponseAsync(
        ...
        return service.updateById(this.client.getHost(), resourceId, apiVersion, parameters, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> updateByIdAsync(String resourceId, String apiVersion, GenericResource parameters) {
        Mono<Response<Flux<ByteBuffer>>> mono = updateByIdWithResponseAsync(resourceId, apiVersion, parameters);
        return this
            .client
            .<GenericResource, GenericResource>getLroResultAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> updateByIdAsync(
        String resourceId, String apiVersion, GenericResource parameters, Context context) {
        Mono<Response<Flux<ByteBuffer>>> mono =
            updateByIdWithResponseAsync(resourceId, apiVersion, parameters, context);
        return this
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> getByIdWithResponseAsync(String resourceId, String apiVersion) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> getByIdWithResponseAsync(
        String resourceId, String apiVersion, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> getByIdAsync(String resourceId, String apiVersion) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> getByIdAsync(String resourceId, String apiVersion, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> beginCreateOrUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> beginCreateOrUpdateWithoutPollingAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> beginUpdateWithoutPollingWithResponseAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> beginUpdateWithoutPollingAsync(
        String resourceGroupName,
        String resourceProviderNamespace,
        String parentResourcePath,
        String resourceType,
    ...
    public Mono<Response<Void>> beginDeleteByIdWithoutPollingWithResponseAsync(String resourceId, String apiVersion) {
        ...
        return FluxUtil
            .withContext(
                context ->
                    service.beginDeleteByIdWithoutPolling(this.client.getHost(), resourceId, apiVersion, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
    ...
    public Mono<Response<Void>> beginDeleteByIdWithoutPollingWithResponseAsync(
        ...
        return service.beginDeleteByIdWithoutPolling(this.client.getHost(), resourceId, apiVersion, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> beginCreateOrUpdateByIdWithoutPollingWithResponseAsync(
        String resourceId, String apiVersion, GenericResource parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
                ...
                context ->
                    service
                        .beginCreateOrUpdateByIdWithoutPolling(
                            this.client.getHost(), resourceId, apiVersion, parameters, context))
            .subscriberContext(context -> context.putAll(FluxUtil.toReactorContext(this.client.getContext())));
    }
    ...
    public Mono<Response<GenericResource>> beginCreateOrUpdateByIdWithoutPollingWithResponseAsync(
        ...
        return service
            .beginCreateOrUpdateByIdWithoutPolling(this.client.getHost(), resourceId, apiVersion, parameters, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> beginCreateOrUpdateByIdWithoutPollingAsync(
        String resourceId, String apiVersion, GenericResource parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<GenericResource>> beginUpdateByIdWithoutPollingWithResponseAsync(
        String resourceId, String apiVersion, GenericResource parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
    ...
    public Mono<Response<GenericResource>> beginUpdateByIdWithoutPollingWithResponseAsync(
        ...
        return service
            .beginUpdateByIdWithoutPolling(this.client.getHost(), resourceId, apiVersion, parameters, context);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<GenericResource> beginUpdateByIdWithoutPollingAsync(
        String resourceId, String apiVersion, GenericResource parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listByResourceGroupNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listByResourceGroupNextSinglePageAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return FluxUtil
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<GenericResourceExpanded>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
