...
@Fluent
public final class TemplateHashResult {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(TemplateHashResult.class);
     ...
     * @return the TemplateHashResult object itself.
     */
    public TemplateHashResult setMinifiedTemplate(String minifiedTemplate) {
     ...
     * @return the TemplateHashResult object itself.
     */
    public TemplateHashResult setTemplateHash(String templateHash) {
