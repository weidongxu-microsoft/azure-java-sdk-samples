...
public final class DeploymentOperation {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DeploymentOperation.class);
     ...
     * @return the DeploymentOperation object itself.
     */
    public DeploymentOperation setProperties(DeploymentOperationProperties properties) {
