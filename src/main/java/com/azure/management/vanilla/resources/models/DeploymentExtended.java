...
@Fluent
public final class DeploymentExtended extends ProxyResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(DeploymentExtended.class);
     ...
     * @return the DeploymentExtended object itself.
     */
    public DeploymentExtended setLocation(String location) {
     ...
     * @return the DeploymentExtended object itself.
     */
    public DeploymentExtended setProperties(DeploymentPropertiesExtended properties) {
