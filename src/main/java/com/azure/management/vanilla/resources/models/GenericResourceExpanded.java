...
@Immutable
public final class GenericResourceExpanded extends GenericResource {
    @JsonIgnore private final ClientLogger logger = new ClientLogger(GenericResourceExpanded.class);
