...
import com.azure.management.vanilla.resources.models.ResourceGroupListResult;
...
public final class ResourceGroupsImpl {
    ...
    /**
     * Initializes an instance of ResourceGroupsImpl.
     *
     * @param client the instance of the service client containing this operation class.
     */
    ResourceGroupsImpl(ResourceManagementClientImpl client) {
        this.service =
    ...
    private interface ResourceGroupsService {
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceGroup>> createOrUpdate(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
            @BodyParam("application/json") ResourceGroup parameters,
            Context context);
        ...
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceGroup>> get(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceGroup>> update(
            @HostParam("$host") String host,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
            @PathParam("subscriptionId") String subscriptionId,
        ...
        @ExpectedResponses({200, 202})
        @UnexpectedResponseExceptionType(ManagementException.class)
        Mono<Response<ResourceGroupExportResult>> beginExportTemplateWithoutPolling(
            @HostParam("$host") String host,
            @PathParam("subscriptionId") String subscriptionId,
            @PathParam("resourceGroupName") String resourceGroupName,
            @QueryParam("api-version") String apiVersion,
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ResourceGroup>> createOrUpdateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> createOrUpdateAsync(String resourceGroupName, ResourceGroup parameters) {
        return createOrUpdateWithResponseAsync(resourceGroupName, parameters)
            .flatMap(
                (Response<ResourceGroup> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> createOrUpdateAsync(
        String resourceGroupName, ResourceGroup parameters, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ResourceGroup>> getWithResponseAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ResourceGroup>> getWithResponseAsync(String resourceGroupName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> getAsync(String resourceGroupName) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> getAsync(String resourceGroupName, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ResourceGroup>> updateWithResponseAsync(
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> updateAsync(String resourceGroupName, ResourceGroupPatchable parameters) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroup> updateAsync(
        String resourceGroupName, ResourceGroupPatchable parameters, Context context) {
    ...
    public PollerFlux<PollResult<ResourceGroupExportResult>, ResourceGroupExportResult> beginExportTemplate(
        ...
        return this
            .client
            .<ResourceGroupExportResult, ResourceGroupExportResult>getLroResultAsync(
                mono, this.client.getHttpPipeline(), ResourceGroupExportResult.class, ResourceGroupExportResult.class);
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ResourceGroup>> listSinglePageAsync(String filter, Integer top) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
                ...
                context ->
                    service
                        .list(
                            ...
                            this.client.getSubscriptionId(),
                            context))
            .<PagedResponse<ResourceGroup>>map(
                res ->
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ResourceGroup>> listSinglePageAsync(String filter, Integer top, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
    ...
    public PagedFlux<ResourceGroup> listAsync(String filter, Integer top) {
     ...
     */
    @ServiceMethod(returns = ReturnType.COLLECTION)
    public PagedFlux<ResourceGroup> listAsync(String filter, Integer top, Context context) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> beginDeleteWithoutPollingWithResponseAsync(String resourceGroupName) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<Void>> beginDeleteWithoutPollingWithResponseAsync(String resourceGroupName, Context context) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName)
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Void> beginDeleteWithoutPollingAsync(String resourceGroupName, Context context) {
        return beginDeleteWithoutPollingWithResponseAsync(resourceGroupName, context)
            .flatMap((Response<Void> res) -> Mono.empty());
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName) {
        beginDeleteWithoutPollingAsync(resourceGroupName).block();
    }
    ...
    public void beginDeleteWithoutPolling(String resourceGroupName, Context context) {
        beginDeleteWithoutPollingAsync(resourceGroupName, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<Response<ResourceGroupExportResult>> beginExportTemplateWithoutPollingWithResponseAsync(
        String resourceGroupName, ExportTemplateRequest parameters) {
        if (this.client.getHost() == null) {
            return Mono
                .error(new IllegalArgumentException("Parameter this.client.getHost() is required and cannot be null."));
        ...
        return FluxUtil
            .withContext(
                context ->
                    service
                        .beginExportTemplateWithoutPolling(
                            this.client.getHost(),
                            this.client.getSubscriptionId(),
                            resourceGroupName,
                            this.client.getApiVersion(),
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<ResourceGroupExportResult> beginExportTemplateWithoutPollingAsync(
        String resourceGroupName, ExportTemplateRequest parameters) {
        return beginExportTemplateWithoutPollingWithResponseAsync(resourceGroupName, parameters)
            .flatMap(
                (Response<ResourceGroupExportResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
                    } else {
                        return Mono.empty();
    ...
    public Mono<ResourceGroupExportResult> beginExportTemplateWithoutPollingAsync(
        String resourceGroupName, ExportTemplateRequest parameters, Context context) {
        return beginExportTemplateWithoutPollingWithResponseAsync(resourceGroupName, parameters, context)
            .flatMap(
                (Response<ResourceGroupExportResult> res) -> {
                    if (res.getValue() != null) {
                        return Mono.just(res.getValue());
    ...
    public ResourceGroupExportResult beginExportTemplateWithoutPolling(
        String resourceGroupName, ExportTemplateRequest parameters) {
        return beginExportTemplateWithoutPollingAsync(resourceGroupName, parameters).block();
    }
    ...
    public ResourceGroupExportResult beginExportTemplateWithoutPolling(
        String resourceGroupName, ExportTemplateRequest parameters, Context context) {
        return beginExportTemplateWithoutPollingAsync(resourceGroupName, parameters, context).block();
    }
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ResourceGroup>> listNextSinglePageAsync(String nextLink) {
        if (nextLink == null) {
     ...
     */
    @ServiceMethod(returns = ReturnType.SINGLE)
    public Mono<PagedResponse<ResourceGroup>> listNextSinglePageAsync(String nextLink, Context context) {
        if (nextLink == null) {
            return Mono.error(new IllegalArgumentException("Parameter nextLink is required and cannot be null."));
        }
        return service
