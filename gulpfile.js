...
function codegen(project, cb) {
    ...
    cmd = autoRestExe + ' ' + readmeFile +
                        ' --java ' +
                        ' --azure-arm ' +
                        ' --generate-sync-async-clients --sync-methods=all --required-parameter-client-methods --add-context-parameter --context-client-method-parameter --client-side-validations --client-logger ' +
                        generator +
